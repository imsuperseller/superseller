...
```bash
ssh root@172.245.56.50 "cd /opt/fb-marketplace-bot && DISPLAY=:100 node interactive_login.js 0"  # UAD
ssh root@172.245.56.50 "cd /opt/fb-marketplace-bot && DISPLAY=:100 node interactive_login.js 1"  # MissParty
```
Then approve 2FA via noVNC: `http://172.245.56.50:6080/vnc.html`
...
- **Auth**: `VtQPhDQtDugSO8av / Lekbt1ZQ7x4oCOVa`
