...
| File | Use |
|------|-----|
| **Lead-Analysis-Supervisor.json** | Lead analysis / Voice AI |
...
**Status:** Legacy unless stated. For live workflow catalog and grouping, see **docs/n8n/N8N_WORKFLOWS_CATALOG.md** and NotebookLM **N8n workflows** notebook.
