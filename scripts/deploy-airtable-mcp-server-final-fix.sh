...
# Final Airtable MCP Server Webhook Deployment Script (IPv4 Fix)
# Deploys the Airtable MCP server as a webhook service on port 5679 with IPv4 support

set -e

echo "🚀 Deploying Airtable MCP Server Webhook to Racknerd VPS (IPv4 Fix)"
echo "===================================================================="
...
# Step 3: Create webhook wrapper with IPv4 support
print_status "Creating webhook wrapper with IPv4 support..."
...
// Start server on all interfaces (IPv4 and IPv6)
