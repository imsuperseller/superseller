...
# Final Airtable MCP Server Webhook Deployment Script
# Deploys the Airtable MCP server as a webhook service on port 5679

set -e

echo "🚀 Deploying Airtable MCP Server Webhook to Racknerd VPS (Final)"
echo "================================================================="
...
# Step 3: Create webhook wrapper with correct port
