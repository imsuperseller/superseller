...
name: ui-ux-pro-max
description: >-
  UI/UX design intelligence with 50+ styles, 97 color palettes, 57 font pairings, and 9 stacks.
  Use when designing landing pages, dashboards, web apps, or choosing color palettes, typography,
  or UI styles. Not for backend logic, database queries, video pipeline work, or n8n automation.
  Example: "Design a SaaS dashboard with dark mode and glassmorphism style".
---
