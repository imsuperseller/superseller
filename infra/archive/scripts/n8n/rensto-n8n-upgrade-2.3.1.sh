...
# ================================================
# This script performs a CAUTIOUS upgrade of Rensto n8n.
# 
...
echo "1. Login to https://n8n.rensto.com"
...
log_info "To clean up later, run: /opt/n8n/rensto-n8n-cleanup-backups.sh"

cat > "/opt/n8n/rensto-n8n-cleanup-backups.sh" << EOF
#!/bin/bash
...
EOF
chmod +x /opt/n8n/rensto-n8n-cleanup-backups.sh
