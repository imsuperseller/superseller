...
def load_cached_tokens() -> AuthTokens | None:
    ...
    try:
        ...
        #     pass # print("Note: Cached tokens are older than 1 week. They may still work.")

        return tokens
    except (json.JSONDecodeError, KeyError, TypeError) as e:
        # pass # print(f"Failed to load cached tokens: {e}")
        return None
...
def save_tokens_to_cache(tokens: AuthTokens, silent: bool = False) -> None:
    ...
    # if not silent:
    #     pass # print(f"Auth tokens cached to {cache_path}")
