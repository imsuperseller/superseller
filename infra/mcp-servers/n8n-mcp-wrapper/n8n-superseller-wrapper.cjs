...
/**
 * n8n-MCP Wrapper for SuperSeller AI Instance
 * 
 ...
 *   "n8n-superseller": {
 *     "command": "node",
 *     "args": ["/path/to/n8n-superseller-wrapper.js"]
 *   }
 * }
 */
...
const logFile = '/tmp/n8n-superseller-wrapper.log';
try {
...
process.env.N8N_API_URL = 'https://n8n.superseller.agency';
...
n8nMcp.on('error', (error) => {
  ...
  console.error('[n8n-superseller-wrapper] Failed to start n8n-mcp:', error);
  process.exit(1);
});
