...
const MODELS = [
  ...
  // ─────────────────────────────────────────
  {
    ...
    walkthrough_notes: "Best for property walkthroughs. Multi-shot storyboarding, Elements for realtor, start+end frame for transitions. Proven in 25+ VideoForge productions.",
  ...
  },
  {
    ...
    walkthrough_notes: "2K resolution > Kling 1080p. Environment Lock keeps background fixed. 12-file multimodal reference. Test for VideoForge.",
  ...
  // ─────────────────────────────────────────
  {
    ...
    supports_native_audio: true,
    quality_overall: 88,
    walkthrough_notes: "Primary music for VideoForge. Luxury real estate piano/ambient style.",
