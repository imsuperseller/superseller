            ...
            {activeSubTab === 'heartbeat' ? (
                ...
                <>
                    <div className="flex items-center gap-4 bg-black/40 backdrop-blur-xl p-4 rounded-[2rem] border border-white/5">
                        ...
                        <Button variant="renstoPrimary" className="rounded-xl font-black uppercase tracking-widest text-[10px] h-12 px-6">
...
function HeartbeatPanel() {
    const healthChecks = [
        ...
        { id: 'n8n-internal', provider: 'n8n_self_hosted', label: 'Rensto Ops Engine', status: 'online', load: '87 Flows Active', lastPing: 'Just Now' },
