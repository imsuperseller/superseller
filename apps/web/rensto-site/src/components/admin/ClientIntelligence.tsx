        ...
        <div className="space-y-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                ...
                <div className="flex gap-3">
                    ...
                    <Button variant="renstoPrimary" className="rounded-xl text-[10px] font-black uppercase tracking-widest h-10">
                        Export CRM Data
                    </Button>
                </div>
            </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                                        ...
                                        <div className="flex items-center justify-between p-4 bg-white/5 rounded-2xl border border-white/5">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="flex flex-col">
                                                    ...
                                                    <span className="text-xs font-bold text-white break-all">{(selectedClient as any).n8nInstance?.url || 'rensto-master'}</span>
                                                </div>
                                            </div>
                        ...
                        <div className="space-y-8">
                            <Card className="p-8 bg-gradient-to-br from-purple-500/10 to-transparent border-purple-500/20 rounded-[2.5rem] space-y-6">
                                ...
                                <Button variant="renstoPrimary" className="w-full rounded-xl text-[10px] font-black uppercase tracking-widest h-12">
                                    Deploy Optimization
                                </Button>
                            </Card>
