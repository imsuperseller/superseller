    ...
    <div className="space-y-12">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          ...
          <p className="text-slate-400 font-medium">Coordinate and monitor the Rensto autonomous agent network.</p>
        </div>
        <button
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {agents.map((agent) => (
          <div
            key={agent.id}
            className={`group relative p-8 rounded-[2rem] border transition-all overflow-hidden flex flex-col ${agent.isRenstoCore
          ...
          >
            ...
            <div className="flex items-start justify-between mb-8">
              <div className="p-4 bg-white/5 rounded-2xl group-hover:scale-110 transition-transform duration-500">
                <Cpu className={`w-6 h-6 ${agent.isRenstoCore ? 'text-[#fe3d51]' : 'text-cyan-400'}`} />
              </div>
            ...
            <div className="flex-1 space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="h-1.5 bg-white/5 rounded-full overflow-hidden">
                  <div
                    className={`h-full transition-all duration-1000 shadow-[0_0_10px_rgba(6,182,212,0.3)] ${agent.isRenstoCore ? 'bg-[#fe3d51]' : 'bg-cyan-500'}`}
