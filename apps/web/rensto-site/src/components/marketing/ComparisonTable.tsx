...
const translations = {
    en: {
        ...
        rensto: "Rensto Business Engine",
        renstoValue: "Fixed Cost. Infinite Scale.",
        comparisons: [
    ...
    he: {
        ...
        rensto: "המנוע העסקי של רנסטו",
        renstoValue: "עלות קבועה. סקייל אינסופי.",
        comparisons: [
            ...
            <div className="mt-20 text-center">
                <div className="inline-block p-8 rounded-3xl bg-white/5 border border-white/10 max-w-3xl">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                        ...
                        <div>
                            <div className="text-cyan-500 text-sm uppercase tracking-wider mb-1 font-sans">{t.rensto}</div>
                            <div className="text-2xl font-bold text-cyan-400 font-sans">{t.renstoValue}</div>
                        </div>
                    </div>
                </div>
            </div>
