                    ...
                    <CardContent className="p-6">
                        <div className="flex items-center justify-between mb-4">
                            ...
                            <div className="flex items-center gap-2">
                                <Label className="text-xs text-gray-400 font-normal">Use Rensto&apos;s Key (+$20/mo)</Label>
                                <Switch
                                    checked={data.useRenstoOpenai || false}
                                    onCheckedChange={(c) => onUpdate({ ...data, useRenstoOpenai: c })}
                                />
                            </div>
                        </div>

                        {!data.useRenstoOpenai && (
