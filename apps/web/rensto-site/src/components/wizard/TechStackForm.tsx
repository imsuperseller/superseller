                        ...
                        return (
                            <div
                                ...
                                className={`relative cursor-pointer p-4 rounded-xl border transition-all duration-300 group hover:scale-[1.02] ${isSelected
                                    ? 'bg-[rgba(30,174,247,0.1)] border-[var(--rensto-cyan)] shadow-[0_0_15px_rgba(30,174,247,0.2)]'
                                    : 'bg-white/5 border-white/10 hover:border-white/20 hover:bg-white/10'
                                    }`}
                            >
                                {isSelected && (
                                    <div className="absolute top-2 right-2">
                                        <div className="bg-[var(--rensto-cyan)] rounded-full p-0.5">
                                ...
                                <div className={`text-center font-medium ${isSelected ? 'text-[var(--rensto-cyan)]' : 'text-gray-300'}`}>
                                    {crm.name}
                                </div>
                            </div>
                        );
                                            ...
                                            {['Twilio', 'Retell', 'Other'].map(p => (
                                                <div
                                                    ...
                                                    className={`cursor-pointer px-3 py-1.5 rounded-lg text-sm border transition-colors ${(data.smsProvider || 'Twilio') === p
                                                            ? 'bg-[var(--rensto-cyan)] text-black border-[var(--rensto-cyan)] font-medium'
