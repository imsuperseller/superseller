...
export function NicheHero({ niche }: NicheHeroProps) {
  return (
    <section className="relative py-32 px-4 overflow-hidden">
      {/* Gradient bg */}
      <div className="absolute inset-0 bg-gradient-to-b from-[var(--rensto-bg-secondary)] to-[var(--rensto-bg-primary)] -z-10" />
      ...
      <div className="container mx-auto max-w-4xl text-center">
        ...
        >
          ...
          <motion.div
            ...
            style={{
              background: 'rgba(var(--rensto-accent-cyan-rgb, 95, 251, 253), 0.08)',
              border: '1px solid rgba(var(--rensto-accent-cyan-rgb, 95, 251, 253), 0.15)',
            }}
          ...
          >
            <NicheIcon
              name={niche.iconName}
              className="w-8 h-8"
              style={{ color: 'var(--rensto-accent-cyan)' }}
            />
          </motion.div>
          ...
          <p className="text-xl text-[var(--rensto-text-secondary)] max-w-2xl mx-auto leading-relaxed">
            {niche.subheadline}
          </p>
        </motion.div>
      </div>
