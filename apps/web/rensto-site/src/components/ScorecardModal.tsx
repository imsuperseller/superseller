            ...
            >
                ...
                {success ? (
                    <div className="text-center py-8">
                        ...
                        >
                            <CheckCircle className="w-8 h-8" style={{ color: 'var(--rensto-accent-cyan)' }} />
                        </div>
                    ...
                    <>
                        <div className="text-center mb-8">
                            ...
                            >
                                <Target className="w-6 h-6" style={{ color: 'var(--rensto-primary)' }} />
                            </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            <div>
                                <label className="block text-sm font-medium mb-1" style={{ color: 'var(--rensto-text-secondary)' }}>
                                    Full Name
                                </label>
                                <input
                                    type="text"
