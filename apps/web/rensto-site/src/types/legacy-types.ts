/**
 * Legacy types — originally from Firestore era (pre-Feb 2026).
 * These interfaces are still used by admin dashboard, marketplace, fulfillment components.
 * Migration to Prisma-generated types is planned but not blocking.
 * File renamed from firestore.ts → legacy-types.ts (Feb 2026).
 */
