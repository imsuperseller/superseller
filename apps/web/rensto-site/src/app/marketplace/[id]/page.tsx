    ...
    try {
        ...
        if (docSnap.exists) {
            ...
            const mapping: any = {
                ...
                video: data.video ? data.video.replace(`http://${process.env.RENSTO_VPS_IP || '172.245.56.50'}`, '') : undefined,
                demoVideo: data.demoVideo ? data.demoVideo.replace(`http://${process.env.RENSTO_VPS_IP || '172.245.56.50'}`, '') : undefined,
