            ...
            <div className="relative min-h-[calc(100vh-8rem)] space-y-12">
                ...
                {loading ? (
                    ...
                    <div className="flex flex-col items-center justify-center p-32 border-2 border-dashed border-white/5 rounded-[3rem] bg-white/[0.01]">
                        ...
                        <h3 className="text-xl font-black text-white uppercase tracking-widest mb-2">Queue Optimized</h3>
                        <p className="text-slate-500 text-center font-medium max-w-sm">
                            Zero pending service instances. All neural channels are fully synchronized.
                        </p>
                    </div>
                ) : (
                                ...
                                <div className="p-8 border-b border-white/5">
                                    <div className="grid md:grid-cols-2 gap-8 items-center">
                                        <div className="flex items-center gap-6">
                                            ...
                                            <div>
                                                <h3 className="text-2xl font-black text-white uppercase tracking-tight mb-1">{instance.productName}</h3>
                                        ...
                                        <div className="flex items-center justify-end gap-4">
                                            <div className="text-right hidden md:block">
                                                ...
                                                <p className="text-xs font-bold text-white uppercase">
                                                    {new Date(instance.createdAt?.seconds * 1000).toLocaleString([], { dateStyle: 'medium', timeStyle: 'short' })}
                                                </p>
                                            </div>
                                            <button
