                                            ...
                                            <div className="flex items-center gap-6">
                                                ...
                                                <div>
                                                    <div className="flex items-center gap-3 mb-1">
                                                        ...
                                                        {PRODUCT_REGISTRY[req.productId || req.solutionId]?.adminLabel && (
                                                            <span className="px-2 py-0.5 bg-cyan-500/10 border border-cyan-500/20 text-cyan-400 text-[8px] font-black uppercase tracking-widest rounded-md">
                                                                Agent: {PRODUCT_REGISTRY[req.productId || req.solutionId].adminLabel}
                                                            </span>
                                                        )}
                                                    </div>
                                            ...
                                            <div className="flex items-center gap-6">
                                                ...
                                                <div>
                                                    <div className="flex items-center gap-3 mb-1">
                                                        ...
                                                        {PRODUCT_REGISTRY[instance.productId]?.adminLabel && (
                                                            <span className="px-2 py-0.5 bg-cyan-500/10 border border-cyan-500/20 text-cyan-400 text-[8px] font-black uppercase tracking-widest rounded-md">
                                                                Agent: {PRODUCT_REGISTRY[instance.productId].adminLabel}
                                                            </span>
                                                        )}
                                                    </div>
                                                    <div className="flex items-center gap-2">
