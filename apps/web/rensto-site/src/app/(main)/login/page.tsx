  ...
  return (
    ...
    >
      ...
      <div ref={containerRef} className="w-full max-w-xl relative z-10">
        ...
        <div ref={logoRef} className="text-center mb-10">
          <div className="flex flex-col items-center justify-center space-y-4 mb-6">
            <div className="w-20 h-20 relative group">
              <div className="absolute inset-0 bg-rensto-red/20 blur-2xl rounded-full group-hover:bg-rensto-red/40 transition-all duration-500" />
              <Image
            ...
            <div className="pt-4">
              ...
              <GradientText>Access Rensto</GradientText>
            </div>
          </div>
        ...
        >
          {/* Subtle Glows */}
          <div className="absolute -top-24 -left-24 w-64 h-64 bg-rensto-red/10 blur-[100px] rounded-full" />
          ...
          {isSuccess ? (
            <div className="relative z-10 text-center py-6">
              ...
              <button
                ...
                className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-500 hover:text-rensto-red transition-all"
              >
                ← Back to sign in
              </button>
            </div>
            ...
            >
              {error && (
                <div className="bg-rensto-red/10 border border-rensto-red/20 rounded-2xl p-5 flex items-center gap-4">
                  <XCircle className="h-6 w-6 text-rensto-red flex-shrink-0" />
                  <p className="text-sm font-semibold text-rensto-red">{error}</p>
                </div>
              )}
                ...
                <div className="relative group">
                  <Input
                    ...
                    className={`h-16 bg-white/[0.03] border-white/5 rounded-2xl px-6 text-lg transition-all duration-300 ${emailValid === true
                      ...
                      : emailValid === false
                        ? 'border-rensto-red/50 focus:border-rensto-red focus:ring-rensto-red/20'
                  ...
                  <div className="absolute right-6 top-1/2 -translate-y-1/2 flex items-center">
                    ...
                    {emailValid === false && email.length > 0 && (
                      <AlertCircle className="h-6 w-6 text-rensto-red drop-shadow-[0_0_10px_rgba(254,61,81,0.5)]" />
                    )}
                    {isLoading && (
              ...
              <MagnetButton
                ...
                className={`
                  ...
                  ${isLoading || !emailValid
                    ...
                    : 'bg-gradient-to-r from-rensto-red to-rensto-orange text-white hover:scale-[1.02] active:scale-[0.98] shadow-rensto-red/20'
                  }
                `}
              >
                {isLoading ? (
