# Rensto Operations Tools

> [!NOTE]
> **Aitable.ai**: In use. These tools manage Aitable sync. Airtable.com and Firestore are retired.

This directory contains utility scripts for managing the Rensto AITable integration and Firestore data flows.
...
| `setup_aitable.js` | **Provisioning**: Connects to the Rensto Space and ensures the Leads datasheet exists. |
