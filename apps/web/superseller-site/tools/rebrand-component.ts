#!/usr/bin/env npx tsx
/**
 * rebrand-component.ts — Convert generic Tailwind/shadcn components to SuperSeller AI brand tokens
 *
 * Usage:
 ...
 *
 * What it does:
 *   1. Replaces generic dark backgrounds with superseller-bg-* tokens
 *   2. Replaces generic accent colors with superseller brand colors
 *   3. Replaces generic text colors with superseller-text-* tokens
 *   4. Replaces generic borders with superseller borders
 *   5. Adds superseller glow/gradient classes where applicable
...
const rules: ReplacementRule[] = [
  // --- BACKGROUNDS ---
  // Dark page backgrounds → superseller-bg-primary
  {
    patterns: [
      /\bbg-gray-950\b/g,
      /\bbg-slate-950\b/g,
    ...
    replacement: 'bg-[var(--superseller-bg-primary)]',
    category: 'background',
  },
  // Panel/surface backgrounds → superseller-bg-secondary
  {
    patterns: [
      /\bbg-gray-800\b(?!\/)/g,
      /\bbg-slate-800\b(?!\/)/g,
    ...
    replacement: 'bg-[var(--superseller-bg-secondary)]',
    category: 'background',
  },
  // Card backgrounds → superseller-bg-card
  {
    patterns: [
      /\bbg-gray-800\/50\b/g,
    ...
    replacement: 'bg-[var(--superseller-bg-card)]',
    category: 'background',
  },
  ...
  // IMPORTANT: hover: variants MUST come before base patterns to avoid premature matching
  {
    ...
    replacement: 'hover:bg-[var(--superseller-red)]/80',
    category: 'accent',
  },
  {
    patterns: [
    ...
    replacement: 'bg-[var(--superseller-red)]',
    category: 'accent',
  },
  {
    patterns: [
    ...
    replacement: 'text-[var(--superseller-red)]',
    category: 'accent',
  },
  ...
  // --- ACCENT COLORS: BLUE ---
  {
    ...
    replacement: 'bg-[var(--superseller-blue)]',
    category: 'accent',
  },
  {
    patterns: [
    ...
    replacement: 'text-[var(--superseller-blue)]',
    category: 'accent',
  },
  ...
  // --- ACCENT COLORS: CYAN/TEAL (highlight) ---
  {
    ...
    replacement: 'bg-[var(--superseller-cyan)]',
    category: 'accent',
  },
  {
    patterns: [
    ...
    replacement: 'text-[var(--superseller-cyan)]',
    category: 'accent',
  },
  ...
  // --- ACCENT COLORS: ORANGE ---
  {
    ...
    replacement: 'bg-[var(--superseller-orange)]',
    category: 'accent',
  },
  {
    patterns: [
    ...
    replacement: 'text-[var(--superseller-orange)]',
    category: 'accent',
  },
  ...
  // Primary text (white / near-white)
  {
    ...
    replacement: 'text-[var(--superseller-text-primary)]',
    category: 'text',
  },
  // Secondary text
  {
    ...
    replacement: 'text-[var(--superseller-text-secondary)]',
    category: 'text',
  },
  // Muted text
  {
    ...
    replacement: 'text-[var(--superseller-text-muted)]',
    category: 'text',
  },
  ...
  // --- BORDERS ---
  {
    ...
    replacement: 'border-[var(--superseller-bg-secondary)]',
    category: 'border',
  },
  {
    patterns: [
  ...
  // --- RING / FOCUS ---
  {
    ...
    replacement: 'ring-[var(--superseller-cyan)]',
    category: 'focus',
  },
  ...
  // --- PLACEHOLDER ---
  {
    ...
    replacement: 'placeholder-[var(--superseller-text-muted)]',
    category: 'text',
  },
];
...
const inlineStyleRules: InlineStyleRule[] = [
  { pattern: /#111827/g, replacement: 'var(--superseller-bg-primary)', category: 'inline-bg' },
  { pattern: /#0f172a/g, replacement: 'var(--superseller-bg-primary)', category: 'inline-bg' },
  { pattern: /#18181b/g, replacement: 'var(--superseller-bg-primary)', category: 'inline-bg' },
  { pattern: /#1f2937/g, replacement: 'var(--superseller-bg-secondary)', category: 'inline-bg' },
  { pattern: /#1e293b/g, replacement: 'var(--superseller-bg-secondary)', category: 'inline-bg' },
  { pattern: /#27272a/g, replacement: 'var(--superseller-bg-secondary)', category: 'inline-bg' },
  { pattern: /#ef4444/g, replacement: 'var(--superseller-red)', category: 'inline-accent' },
  { pattern: /#f43f5e/g, replacement: 'var(--superseller-red)', category: 'inline-accent' },
  { pattern: /#3b82f6/g, replacement: 'var(--superseller-blue)', category: 'inline-accent' },
  { pattern: /#0ea5e9/g, replacement: 'var(--superseller-blue)', category: 'inline-accent' },
  { pattern: /#22d3ee/g, replacement: 'var(--superseller-cyan)', category: 'inline-accent' },
  { pattern: /#2dd4bf/g, replacement: 'var(--superseller-cyan)', category: 'inline-accent' },
];
