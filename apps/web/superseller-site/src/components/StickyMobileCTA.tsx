            ...
            <div className="mx-4 mb-4" suppressHydrationWarning>
                <div className="bg-[#0B0F19]/80 backdrop-blur-xl border border-white/10 rounded-2xl p-4 shadow-[0_-10px_40px_-15px_rgba(30,174,247,0.3)] flex items-center justify-between gap-4" suppressHydrationWarning>
                    <div className="flex items-center gap-3" suppressHydrationWarning>
                        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-superseller-blue/20 to-superseller-cyan/20 flex items-center justify-center border border-white/5">
                            <Zap className="w-5 h-5 text-superseller-blue" />
                        </div>
                        <div className="flex flex-col" suppressHydrationWarning>
                            <span className="text-xs font-bold text-superseller-blue tracking-wider uppercase" suppressHydrationWarning>
                    ...
                    <Link href="/custom" className="flex-shrink-0" suppressHydrationWarning>
                        <button className="bg-gradient-to-r from-superseller-blue to-superseller-cyan text-white text-xs font-bold px-5 py-3 rounded-xl shadow-[0_0_20px_-5px_rgba(30,174,247,0.5)] active:scale-95 transition-all flex items-center gap-2" suppressHydrationWarning>
