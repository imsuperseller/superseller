    ...
    if (loading) {
        return (
            <div className="flex items-center justify-center p-8">
                <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-superseller-primary"></div>
            </div>
        );
    }
        ...
        <div className="space-y-6">
                ...
                {[
                    ...
                    <button
                        ...
                        className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${filter === key
                                ...
                                : 'bg-superseller-card text-superseller-text hover:bg-superseller-accent'
                            }`}
                    >
                        {label} ({count})
                    </button>
            ...
            <div className="space-y-4">
                {sortedTasks.length === 0 ? (
                    <div className="text-center py-8 text-superseller-text-muted">
