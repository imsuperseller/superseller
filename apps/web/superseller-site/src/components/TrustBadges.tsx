...
export function TrustBadges() {
    ...
    const badges = [
        ...
        },
        {
            ...
            color: 'var(--superseller-accent-blue)'
        },
        {
            icon: CheckCircle,
            label: 'Custom Built',
                        ...
                        return (
                            ...
                            >
                                ...
                                >
                                    ...
                                    {/* Label */}
                                    <div className="text-sm font-bold mb-1" style={{ color: 'var(--superseller-text-primary)' }}>
                                        {badge.label}
                                    </div>

                                    {/* Description */}
                                    <div className="text-xs" style={{ color: 'var(--superseller-text-secondary)' }}>
                                        {badge.description}
                                    </div>
