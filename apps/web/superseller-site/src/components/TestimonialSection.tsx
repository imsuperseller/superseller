...
const FALLBACK_TESTIMONIALS: Testimonial[] = [
    {
        quote: "SuperSeller AI transformed our lead management process. What used to take 3 hours daily now happens automatically in minutes.",
        author: "Michael Chen",
...
export function TestimonialSection() {
    ...
    if (isLoading) {
        return (
            <section className="py-16 px-4" style={{ background: 'var(--superseller-bg-secondary)' }}>
                <div className="container mx-auto max-w-5xl text-center">
                    <div className="text-xl" style={{ color: 'var(--superseller-text-secondary)' }}>
                ...
                <div className="relative">
                    ...
                    >
                        ...
                        <div className="absolute top-8 left-8 opacity-10">
                            <Quote className="w-24 h-24" style={{ color: 'var(--superseller-primary)' }} />
                        </div>
                        ...
                        <div className="relative z-10">
                            ...
                            {/* Quote */}
                            <blockquote className="text-xl md:text-2xl font-medium text-center mb-8 leading-relaxed" style={{ color: 'var(--superseller-text-primary)' }}>
                            ...
                            <div className="flex flex-col md:flex-row items-center justify-center gap-4 mb-6">
                                ...
                                <div className="text-center md:text-left">
                                    <div className="font-bold text-lg" style={{ color: 'var(--superseller-text-primary)' }}>
                                        {current.author}
                                    </div>
                                ...
                                <div
                                    ...
                                    style={{
                                        ...
                                        color: 'var(--superseller-accent-cyan)',
                    ...
                    <div className="flex justify-between items-center mt-8">
                        <div className="flex gap-4">
                            ...
                            >
                                <ChevronLeft className="w-6 h-6" style={{ color: 'var(--superseller-text-primary)' }} />
                            </button>
                            <button
                                ...
                                style={{ boxShadow: '0 4px 20px -4px rgba(0,0,0,0.3)' }}
                            >
                                <ChevronRight className="w-6 h-6" style={{ color: 'var(--superseller-text-primary)' }} />
                            </button>
                        </div>
