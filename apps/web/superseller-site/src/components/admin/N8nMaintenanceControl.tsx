                        ...
                        <div className="p-8 rounded-[2.5rem] bg-gradient-to-br from-cyan-600/10 to-transparent border border-cyan-500/10 space-y-6 relative overflow-hidden">
                            ...
                            <div className="flex items-center justify-between relative z-10">
                                ...
                                {agentData?.updatesAvailable ? (
                                    ...
                                    <Badge variant="supersellerSuccess" className="shadow-lg shadow-green-500/20">SYNCED</Badge>
                                )}
                            </div>
                    ...
                    <div className="p-8 rounded-[2.5rem] bg-white/[0.02] border border-white/5 space-y-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex justify-between items-center group">
                                ...
                                <Badge variant={parseInt(status?.diagnostics?.recentLogErrors) > 0 ? 'destructive' : 'supersellerSuccess'} className="h-4 px-1 text-[8px]">
