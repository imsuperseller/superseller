      ...
      const mockTemplates: WorkflowTemplate[] = [
        {
          ...
          documentationUrl: 'https://github.com/superseller/superseller/blob/main/docs/workflow-templates/n8n-workflows/01-advanced-business-process-automation.md',
          n8nWorkflowId: '0Ss043Wge5zasNWy',
          webhookUrl: 'https://n8n.superseller.agency/webhook/lead-machine-prod',
        ...
        },
        {
          ...
          status: 'Deployed',
          deploymentStatus: 'Active',
          documentationUrl: 'https://github.com/superseller/superseller/blob/main/docs/workflow-templates/n8n-workflows/02-real-time-analytics-dashboard.md',
          n8nWorkflowId: 'yOH1RZI5ZaKc9zy4',
          webhookUrl: 'http://n8n.superseller.agency/webhook/analytics-dashboard',
          lastDeployed: '2025-01-25',
          successRate: 98,
          errorCount: 1,
        ...
        },
        {
          ...
          documentationUrl: 'https://github.com/superseller/superseller/blob/main/docs/workflow-templates/n8n-workflows/03-customer-onboarding-automation.md',
          successRate: 0,
          errorCount: 0,
        ...
        },
        {
          ...
          status: 'Deployed',
          deploymentStatus: 'Active',
          documentationUrl: 'https://github.com/superseller/superseller/blob/main/docs/workflow-templates/n8n-workflows/lead-machine.md',
          n8nWorkflowId: '0Ss043Wge5zasNWy',
          webhookUrl: 'https://n8n.superseller.agency/webhook/lead-machine',
          lastDeployed: '2025-01-25',
          successRate: 100,
          errorCount: 0,
                    ...
                    <div className="space-y-1">
                      ...
                      {template.n8nWorkflowId && (
                        <Button
                          ...
                          size="sm"
                          className="w-full justify-start"
                          onClick={() => window.open(`http://n8n.superseller.agency/workflow/${template.n8nWorkflowId}`, '_blank')}
                        >
