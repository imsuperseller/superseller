...
export default function AgentDashboard() {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-64">
        <RefreshCw className="h-8 w-8 superseller-animate-glow" />
  ...
  return (
    <div className="space-y-6">
              ...
              <CardContent className="space-y-4">
                ...
                {metrics && (
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div className="flex items-center space-x-2">
                      <Clock className="h-4 w-4 style={{ color: 'var(--superseller-blue)' }}" />
                      <span>
                        {(metrics.averageExecutionTime / 1000).toFixed(1)}s avg
                      </span>
                    </div>
                    <div className="flex items-center space-x-2">
                      <XCircle className="h-4 w-4 style={{ color: 'var(--superseller-red)' }}" />
      ...
      {selectedAgent && (
        <Card variant="supersellerNeon" className="mt-6 superseller-card hover:superseller-glow">
          <CardHeader>
