    ...
    return (
        <div className="space-y-12">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                <div>
                    <h2 className="text-3xl font-black uppercase tracking-tighter text-white">SuperSeller AI Treasury</h2>
                ...
                <div className="flex gap-3">
                    ...
                    <Button variant="supersellerPrimary" className="rounded-2xl text-xs font-black uppercase tracking-widest px-8">
                        Upload Invoice
                    </Button>
                </div>
            </div>
                ...
                <div className="space-y-6">
                    ...
                    <Card className="p-8 rounded-[2.5rem] bg-gradient-to-br from-cyan-500/10 to-transparent border-cyan-500/20 space-y-8 relative overflow-hidden">
                        ...
                        <div className="space-y-4">
                            ...
                            <Button variant="supersellerPrimary" size="sm" className="w-full rounded-xl text-[10px] font-black uppercase tracking-widest h-10">
                                Apply Terry's Fix
                            </Button>
                        </div>
