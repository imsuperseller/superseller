                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-8">
                        <div className="space-y-4">
                            ...
                            <p className="text-[var(--superseller-text-secondary)] text-lg">
                        ...
                        <div className="space-y-4 bg-white/5 p-6 rounded-2xl border border-white/5">
                            <div className="flex justify-between items-center">
                                <label className="flex items-center gap-2 text-[var(--superseller-text-primary)] font-medium">
                                    <Clock className="w-4 h-4 text-[var(--superseller-accent-cyan)]" />
                                    Hours spent on manual tasks (weekly)
                                </label>
                                <span className="text-2xl font-bold text-[var(--superseller-accent-cyan)]">{hoursPerWeek}h</span>
                            </div>
                            <input
                                type="range"
                                min="1"
                                ...
                                className="w-full h-2 bg-white/10 rounded-lg appearance-none cursor-pointer accent-[var(--superseller-accent-cyan)]"
                                style={{
                                    backgroundImage: `linear-gradient(to right, var(--superseller-accent-cyan) 0%, var(--superseller-accent-cyan) ${(hoursPerWeek / 40) * 100}%, rgba(255,255,255,0.1) ${(hoursPerWeek / 40) * 100}%, rgba(255,255,255,0.1) 100%)`
                                }}
                            />
                            <div className="flex justify-between text-xs text-[var(--superseller-text-secondary)]">
                                <span>1 hour</span>
                                <span>40 hours</span>
                            </div>
                        </div>
                        ...
                        <div className="space-y-4 bg-white/5 p-6 rounded-2xl border border-white/5">
                            <div className="flex justify-between items-center">
                                <label className="flex items-center gap-2 text-[var(--superseller-text-primary)] font-medium">
                                    <DollarSign className="w-4 h-4 text-[var(--superseller-primary)]" />
                                    Average hourly rate (fully loaded)
                                </label>
                                <div className="relative">
                                    <span className="absolute left-3 top-1/2 -translate-y-1/2 text-[var(--superseller-text-secondary)]">$</span>
                                    <input
                                        type="number"
                                        min="10"
                                        max="500"
                                        ...
                                        className="w-24 bg-black/30 border border-white/10 rounded-lg py-2 pl-6 pr-3 text-right text-white font-bold focus:outline-none focus:border-[var(--superseller-primary)] transition-colors"
                                    />
                                </div>
                            </div>
                            <input
                                ...
                                value={hourlyRate}
                                onChange={(e) => setHourlyRate(Number(e.target.value))}
                                className="w-full h-2 bg-white/10 rounded-lg appearance-none cursor-pointer accent-[var(--superseller-primary)]"
                                style={{
                                    backgroundImage: `linear-gradient(to right, var(--superseller-primary) 0%, var(--superseller-primary) ${(hourlyRate / 200) * 100}%, rgba(255,255,255,0.1) ${(hourlyRate / 200) * 100}%, rgba(255,255,255,0.1) 100%)`
                                }}
                            />
                        </div>
                    </div>
                    ...
                    <div className="relative">
                        ...
                        <div className="relative bg-black/40 border border-white/10 rounded-3xl p-8 space-y-6 backdrop-blur-md">
                            ...
                            <div className="text-center space-y-2 pb-6 border-b border-white/10">
                                <p className="text-[var(--superseller-text-secondary)] font-medium uppercase tracking-wider text-sm">Projected Annual Savings</p>
                                <div className="text-5xl md:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-white via-[var(--superseller-accent-cyan)] to-white animate-in fade-in zoom-in duration-500 key={annualSavings}">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="bg-white/5 rounded-xl p-4 border border-white/5 text-center">
                                    ...
                                    <p className="text-xs text-[var(--superseller-text-secondary)] mt-1">First Year ROI</p>
                                </div>

                                {/* Payback Period Card */}
                                <div className="bg-white/5 rounded-xl p-4 border border-white/5 text-center">
                                    <div className="flex justify-center mb-2">
                                        <Clock className="w-5 h-5 text-[var(--superseller-accent-cyan)]" />
                                    </div>
                                    <div className="text-2xl font-bold text-[var(--superseller-accent-cyan)]">
                                        {paybackWeeks < 1 ? '< 1' : Math.round(paybackWeeks)} wks
                                    </div>
                                    <p className="text-xs text-[var(--superseller-text-secondary)] mt-1">Payback Period</p>
                                </div>
                            </div>

                            <div className="pt-4">
                                <p className="text-xs text-center text-[var(--superseller-text-secondary)] mb-4">
