...
export function WhatsAppButton({
    phoneNumber = '12144362102', // SuperSeller AI WhatsApp number
    message = "Hi SuperSeller AI, I'm interested in automating my business. I saw your website and want to learn more!"
}: WhatsAppButtonProps) {
