      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {niche.pains.map((pain, i) => (
            <motion.div
              key={i}
              className="flex items-start gap-4 p-6 rounded-2xl border border-[var(--superseller-primary)]/10 bg-[var(--superseller-primary)]/5"
            ...
            >
              <AlertTriangle
                ...
                style={{ color: 'var(--superseller-primary)' }}
              />
              <p className="text-[var(--superseller-text-secondary)] font-medium">
                {pain}
              </p>
            </motion.div>
          ))}
