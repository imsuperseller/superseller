        ...
        <div className="space-y-6">
                            ...
                            <div className="grid md:grid-cols-2 gap-8">
                                <div className="space-y-4">
                                    <div className="p-4 rounded-xl border border-white/5 bg-white/[0.02]">
                                        ...
                                        <p className="text-white font-medium text-lg">{config?.agentName || 'SuperSeller AI AI Assistant'}</p>
            ...
            <div className="bg-gradient-to-r from-purple-500/10 to-transparent border-l-4 border-purple-500 p-4 rounded-r-xl">
                <div className="flex items-center justify-between">
                    ...
                    <Button size="sm" variant="supersellerSecondary" className="text-xs h-8">
                        Get Number
                    </Button>
                </div>
            </div>
