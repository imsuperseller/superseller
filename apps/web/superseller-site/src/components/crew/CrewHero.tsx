  ...
  return (
    ...
    >
      ...
      <motion.div className="absolute inset-0 -z-10" style={{ y: backgroundY }}>
        ...
        />
        <div className="absolute inset-0 bg-gradient-to-b from-transparent via-[var(--superseller-bg-primary)]/50 to-[var(--superseller-bg-primary)]" />
      </motion.div>
      ...
      >
        <div className="space-y-8" style={{ perspective: '800px' }}>
          ...
          {/* Trust line */}
          <motion.p
            className="text-sm text-[var(--superseller-text-muted)] pt-4"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
