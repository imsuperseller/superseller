...
// Pre-defined JSON-LD data for SuperSeller AI
export const organizationSchema = {
    name: 'SuperSeller AI',
    url: 'https://superseller.agency',
    logo: 'https://superseller.agency/superseller-logo.webp',
    ...
    sameAs: [
        'https://www.facebook.com/SuperSellerAgencyAI',
        'https://www.instagram.com/superseller.agency/',
        'https://x.com/iamsuperseller',
        'https://www.tiktok.com/@superseller09',
        'https://www.linkedin.com/company/42727872/'
    ],
    contactPoint: {
        '@type': 'ContactPoint',
...
export const serviceSchemas = {
    starter: {
        ...
        provider: { '@type': 'Organization', name: 'SuperSeller AI' },
        offers: {
            '@type': 'Offer',
            price: '79.00',
            priceCurrency: 'USD',
