...
export default function ClientDashboardClient({
    ...
    const getStatusColor = (status: string) => {
        switch (status) {
            ...
            case 'paid':
            case 'launch':
                return 'var(--superseller-cyan)';
            case 'configuring':
            case 'provisioning':
            case 'build':
                return 'var(--superseller-blue)';
            case 'in_progress':
            case 'pending':
                return 'var(--superseller-orange)';
            case 'review':
                return 'var(--superseller-blue)';
            case 'overdue':
                return 'var(--superseller-primary)';
            default:
                return 'var(--superseller-text-muted)';
        }
    };
    ...
    return (
        <div
            ...
            style={{ backgroundColor: 'var(--superseller-bg-primary)' }}
        >
            ...
            <header
                ...
                style={{
                    backgroundColor: 'var(--superseller-bg-card)',
                    borderColor: 'var(--superseller-bg-secondary)'
                }}
            >
                    ...
                    {visibleTabs.filter(tab => tab.visible).map(tab => {
                        ...
                        return (
                            <button
                                ...
                                style={{
                                    backgroundColor: activeTab === tab.id ? 'var(--superseller-bg-secondary)' : 'transparent',
                                    color: activeTab === tab.id ? 'var(--superseller-cyan)' : 'var(--superseller-text-muted)',
                                    border: activeTab === tab.id ? '1px solid var(--superseller-cyan)' : '1px solid transparent'
                                }}
                ...
                {activeTab === 'overview' && (
                    <div className="space-y-6">
                        ...
                        <div
                            ...
                            style={{ backgroundColor: 'var(--superseller-bg-card)' }}
                        >
                            ...
                            <div
                                ...
                                style={{ backgroundColor: 'var(--superseller-bg-secondary)' }}
                            >
                                <div
                                    className="h-full rounded-full transition-all duration-500"
                                    style={{
                                        width: `${project.progress}%`,
                                        background: 'var(--superseller-gradient-secondary)'
                                    }}
                                />
                            </div>
                            <div className="flex justify-between mt-2">
                                <span style={{ color: 'var(--superseller-text-muted)' }} className="text-sm">
                        ...
                        <div className="grid md:grid-cols-3 gap-4">
                            ...
                            >
                                <div className="flex items-center gap-3 mb-3">
                                    ...
                                    >
                                        <Package className="w-5 h-5" style={{ color: 'var(--superseller-cyan)' }} />
                                    </div>
                                    <span style={{ color: 'var(--superseller-text-muted)' }} className="text-sm">
                                        Status
                                    </span>
                            ...
                            >
                                <div className="flex items-center gap-3 mb-3">
                                    <div
                                        ...
                                        style={{ backgroundColor: 'rgba(95, 251, 253, 0.2)' }}
                                    >
                                        <CheckCircle2 className="w-4 h-4" style={{ color: 'var(--superseller-cyan)' }} />
                                    </div>
                                    <span style={{ color: 'var(--superseller-text-muted)' }} className="text-sm">
                                        Completed
                                    </span>
                            ...
                            >
                                <div className="flex items-center gap-3 mb-3">
                                    <div
                                        ...
                                        style={{ backgroundColor: 'rgba(95, 251, 253, 0.2)' }}
                                    >
                                        <TrendingUp className="w-5 h-5" style={{ color: 'var(--superseller-cyan)' }} />
                                    </div>
                                    <span style={{ color: 'var(--superseller-text-muted)' }} className="text-sm">
                                        LLM Usage
                                    </span>
                            ...
                            >
                                <div className="flex items-center gap-3 mb-3">
                                    <div
                                        ...
                                        style={{ backgroundColor: 'rgba(95, 251, 253, 0.2)' }}
                                    >
                                        <Users className="w-5 h-5" style={{ color: 'var(--superseller-cyan)' }} />
                                    </div>
                                    <span style={{ color: 'var(--superseller-text-muted)' }} className="text-sm">
                                        Leads
                                    </span>
                            ...
                            >
                                <div className="flex items-center gap-3 mb-3">
                                    <div
                                        ...
                                        style={{ backgroundColor: 'rgba(95, 251, 253, 0.2)' }}
                                    >
                                        <MessageSquare className="w-5 h-5" style={{ color: 'var(--superseller-cyan)' }} />
                                    </div>
                                    <span style={{ color: 'var(--superseller-text-muted)' }} className="text-sm">
                                        Conversations
                                    </span>
                            ...
                            >
                                <div className="flex items-center gap-3 mb-3">
                                    <div
                                        ...
                                        style={{ backgroundColor: 'rgba(95, 251, 253, 0.2)' }}
                                    >
                                        <Calendar className="w-5 h-5" style={{ color: 'var(--superseller-cyan)' }} />
                                    </div>
                                    <span style={{ color: 'var(--superseller-text-muted)' }} className="text-sm">
                                        Bookings
                                    </span>
                        ...
                        >
                            ...
                            <div className="grid md:grid-cols-2 gap-3">
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        <Calendar className="w-5 h-5" style={{ color: 'var(--superseller-cyan)' }} />
                                        <span style={{ color: 'var(--superseller-text-primary)' }}>Schedule Family Strategy Call</span>
                                    </div>
                                    <ExternalLink className="w-4 h-4" style={{ color: 'var(--superseller-text-muted)' }} />
                                </button>
                                <button
                                    onClick={() => window.location.href = 'mailto:support@superseller.agency'}
                                    className="flex items-center justify-between p-4 rounded-lg transition-all hover:opacity-80 text-left w-full"
                                    style={{ backgroundColor: 'var(--superseller-bg-secondary)' }}
                                >
                                    <div className="flex items-center gap-3">
                                        <MessageSquare className="w-5 h-5" style={{ color: 'var(--superseller-cyan)' }} />
                                        <span style={{ color: 'var(--superseller-text-primary)' }}>Contact Support</span>
                                    </div>
                                    <ExternalLink className="w-4 h-4" style={{ color: 'var(--superseller-text-muted)' }} />
                                </button>
                            </div>
                ...
                {activeTab === 'agent' && (
                    <div className="rounded-xl p-6 min-h-[500px] flex flex-col items-center justify-center text-center"
                        ...
                        <div className="w-20 h-20 rounded-full bg-cyan-500/10 flex items-center justify-center mb-6">
                            <Bot className="w-10 h-10" style={{ color: 'var(--superseller-cyan)' }} />
                        </div>
                        <h2 className="text-2xl font-bold mb-4" style={{ color: 'var(--superseller-text-primary)' }}>
                            Chat Hub (Beta)
                        </h2>
                        <p className="max-w-md text-lg mb-8" style={{ color: 'var(--superseller-text-secondary)' }}>
                        ...
                        <p className="text-sm" style={{ color: 'var(--superseller-text-muted)' }}>
                            {project.status === 'onboarding' || project.status === 'paid'
                        ...
                        {project.deliverables.length > 0 ? (
                            project.deliverables.map((deliverable, i) => (
                                <div
                                    ...
                                    style={{ borderColor: 'var(--superseller-bg-secondary)' }}
                                >
                                    <div className="flex items-center gap-4">
                                        <div
                                ...
                                >
                                    <div className="flex items-center gap-4">
                                        <div
                                            ...
                                            style={{ backgroundColor: 'var(--superseller-bg-secondary)' }}
                                        >
                                            <FileText className="w-5 h-5" style={{ color: 'var(--superseller-cyan)' }} />
                                        </div>
                                        <div>
                                            <p
                                                className="font-medium"
                ...
                {activeTab === 'products' && (
                    <div className="grid md:grid-cols-2 gap-4">
                        {purchasedProducts.length > 0 ? (
                            ...
                            <div className="col-span-full p-12 text-center" style={{ backgroundColor: 'var(--superseller-bg-card)' }}>
