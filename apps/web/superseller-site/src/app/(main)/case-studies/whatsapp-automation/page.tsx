...
export default function CaseStudyPage() {
    const breadcrumbData = {
        itemListElement: [
            ...
            { '@type': 'ListItem', position: 2, name: 'Case Studies', item: 'https://superseller.agency/case-studies' },
            { '@type': 'ListItem', position: 3, name: 'WhatsApp Automation', item: 'https://superseller.agency/case-studies/whatsapp-automation' }
        ]
    };
                ...
                <section className="py-24 px-6 border-b border-white/5">
                    <div className="container mx-auto max-w-4xl space-y-8 text-center">
                        ...
                        <p className="text-xl text-slate-400 leading-relaxed max-w-2xl mx-auto">
                            How a high-growth retail brand used SuperSeller AI's WhatsApp Router to automate 70% of inquiries and increase sales by 22%.
                        </p>
                ...
                <section className="py-24 px-6">
                    <div className="container mx-auto max-w-3xl space-y-16">
                        ...
                        <div className="p-12 rounded-[2.5rem] bg-[#1a1438]/60 border border-white/10 space-y-8 relative overflow-hidden">
                            ...
                            <h2 className="text-3xl font-bold">The SuperSeller AI Architecture</h2>
                            <div className="space-y-6">
                                <Step
                                    number="1"
