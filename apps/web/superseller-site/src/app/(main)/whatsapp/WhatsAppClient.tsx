        ...
        <div className="min-h-screen flex flex-col bg-[#0a0a0a]">
            ...
            <main className="flex-grow">
                    ...
                    <div className="container relative mx-auto px-4 text-center z-10">
                        ...
                        >
                            ...
                            <GradientText className="mb-10 text-center">
                                ...
                                <span className="text-superseller-red">Sales Intelligence</span>
                            </GradientText>
                    ...
                    <div className="container mx-auto px-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                            {BUNDLES.map(bundle => (
                                ...
                                >
                                    {bundle.highlight && (
                                        <div className="absolute -top-4 px-6 py-2 bg-superseller-red text-white font-black text-[10px] uppercase tracking-[0.3em] rounded-full shadow-lg">
                                            {bundle.tagline}
                                        </div>
                                    )}
                                    {!bundle.highlight && (
                                    ...
                                    <ul className="space-y-4 mb-10 text-left w-full">
                                        {bundle.features.map((feat, i) => (
                                            <li key={i} className="flex items-start gap-3 text-sm font-medium text-slate-300">
                                                <div className={`mt-1 p-0.5 rounded-full ${bundle.highlight ? 'bg-superseller-red/20 text-superseller-red' : 'bg-white/10 text-slate-500'}`}>
                                    ...
                                    <div className="mt-auto pt-8 w-full">
                                        <Button
                                            className={`w-full font-black uppercase tracking-[0.2em] text-[10px] h-14 rounded-2xl transition-all duration-300 ${bundle.highlight ? 'bg-gradient-to-r from-superseller-red to-superseller-orange text-white shadow-xl shadow-superseller-red/20' : 'bg-white/5 hover:bg-white/10 text-white'}`}
                                        >
                                            Initialize Bundle
                                        </Button>
                                    </div>
                ...
                <section id="configurator" className="py-32 bg-[#050505] border-t border-white/5 relative overflow-hidden">
                    <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-superseller-red/5 blur-[120px] rounded-full pointer-events-none" />
                        ...
                        <div className="flex flex-col lg:flex-row gap-16">
                            ...
                            <div className="flex-1">
                                <div className="mb-12">
                                    ...
                                    <h2 className="text-4xl font-black text-white uppercase tracking-tight mb-4">Architect Your <span className="text-superseller-red">Agent</span></h2>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    {ADDONS.map(addon => (
                                        ...
                                        >
                                            {selectedAddons.includes(addon.id) && (
                                                <div className="absolute top-0 right-0 w-24 h-24 bg-superseller-red/10 blur-3xl rounded-full" />
                                            )}
                                            ...
                                            <div className="flex justify-between items-start mb-6">
                                                <div className={`p-4 rounded-2xl transition-colors duration-300 ${addon.available === false ? 'bg-white/5 text-slate-700' : selectedAddons.includes(addon.id) ? 'bg-superseller-red/20 text-superseller-red' : 'bg-white/5 text-slate-400 group-hover:text-white'}`}>
                                            ...
                                            {selectedAddons.includes(addon.id) && addon.available !== false && (
                                                <div className="absolute top-6 right-6 text-superseller-red">
                                                    <CheckCircle2 className="w-5 h-5 fill-superseller-red/10" />
                                                </div>
                                            )}
                                        </button>
                                    ))}
                            ...
                            <div className="lg:w-[400px]">
                                <div className="sticky top-32 bg-[#0a0a0a] border border-white/10 rounded-[3rem] p-10 backdrop-blur-3xl shadow-2xl relative overflow-hidden">
                                    <div className="absolute top-0 inset-x-0 h-1 bg-gradient-to-r from-transparent via-superseller-red/50 to-transparent" />

                                    <div className="flex items-center gap-3 mb-10">
                                        <Terminal className="w-4 h-4 text-superseller-red" />
                                    ...
                                    <div className="space-y-8 mb-12">
                                        <div>
                                            ...
                                            <div className="h-1 w-full bg-white/5 rounded-full overflow-hidden">
                                                <div className="h-full bg-superseller-red w-2/3" />
                                            </div>
                                        </div>
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            <div className="flex flex-wrap gap-2">
                                                ...
                                                {selectedAddons.map(id => (
                                                    <Badge key={id} className="bg-superseller-red/10 text-superseller-red border-superseller-red/20 px-3 py-1.5 text-[9px] font-black uppercase tracking-widest">
                                    ...
                                    <Button
                                        className="w-full h-20 bg-gradient-to-r from-superseller-red to-superseller-orange text-white font-black uppercase tracking-[0.4em] text-[10px] rounded-[1.5rem] shadow-2xl shadow-superseller-red/20 hover:scale-[1.02] active:scale-[0.98] transition-all group overflow-hidden relative"
                ...
                <section className="py-32 bg-black relative">
                    <div className="absolute top-1/2 left-0 w-64 h-64 bg-superseller-red/5 blur-[120px] rounded-full" />
                    <div className="container mx-auto px-4 max-w-4xl relative z-10">
                        <div className="text-center mb-20">
                            <Badge className="mb-4 bg-white/5 text-slate-500 border-white/10 px-4 py-1.5 uppercase tracking-[0.3em] text-[10px] font-black">
                                Intelligence Base
                            </Badge>
                            <h2 className="text-4xl font-black text-white uppercase tracking-tight">Technical <span className="text-superseller-red">Manifest</span></h2>
                        </div>
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            {[
                                ...
                                { q: "How does CRM synchronization work?", a: "The SuperSeller AI Brain maps data points directly to your central CRM (HubSpot, Salesforce, Pipedrive) in real-time. No manual entry required." },
                                ...
                                <div key={i} className="bg-white/[0.02] p-8 rounded-[2rem] border border-white/5 hover:border-white/10 transition-all duration-300">
                                    <h3 className="font-black text-white uppercase tracking-tight mb-4 flex items-center gap-3">
                                        <div className="w-1.5 h-1.5 bg-superseller-red rounded-full" />
                                        {item.q}
                                    </h3>
