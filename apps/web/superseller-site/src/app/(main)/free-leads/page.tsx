...
export default function FreeLeadsPage() {
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0a] text-white selection:bg-superseller-red/30">
            <Header />
            ...
            <main className="relative pt-32 pb-32 px-4 sm:px-6 lg:px-8 overflow-hidden min-h-screen flex flex-col justify-center">
                {/* Background Glows */}
                <div className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-superseller-red/5 blur-[120px] rounded-full pointer-events-none" />
                            ...
                            >
                                <div className="space-y-10 text-left">
                                    <div className="inline-flex items-center gap-3 px-5 py-2 rounded-full bg-white/[0.03] border border-white/10 backdrop-blur-md">
                                        <Sparkles className="w-4 h-4 text-superseller-red animate-pulse" />
                                        <span className="text-[10px] font-black uppercase tracking-[0.3em] text-white/80">Operational Offer</span>
                                    </div>

                                    <div className="space-y-6">
                                        <GradientText>
                                            Fuel Your Pipeline With <span className="text-superseller-red">10 Free</span> Premium Leads
                                        </GradientText>
                                        <p className="text-xl text-slate-400 max-w-xl leading-relaxed font-medium">
                                            Test the <span className="text-white font-bold">SuperSeller AI Intelligent Extraction Engine</span>.
                                ...
                                >
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
                                        ...
                                        <Button
                                            type="submit"
                                            className="w-full h-18 text-xs font-black uppercase tracking-[0.4em] bg-gradient-to-r from-superseller-red to-superseller-orange hover:scale-[1.02] active:scale-[0.98] transition-all rounded-2xl shadow-xl shadow-superseller-red/20 py-6"
                                            disabled={loading}
                                        >
                                            {loading ? (
                                ...
                                <div className="bg-white/[0.02] border border-white/10 rounded-[4rem] p-16 md:p-24 backdrop-blur-3xl text-center space-y-10 shadow-2xl relative overflow-hidden">
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <p className="success-element text-xl text-slate-400 font-medium max-w-xl mx-auto leading-relaxed">
                                            The SuperSeller AI Extraction Engine is currently scrubbing the web for high-intent prospects in:
                                            <br />
                                        ...
                                        <div className="flex flex-col items-center gap-4">
                                            <div className="w-full max-w-xs h-1.5 bg-white/5 rounded-full overflow-hidden">
                                                <motion.div
                                                    ...
                                                    className="h-full bg-gradient-to-r from-superseller-red to-cyan-400"
                                                />
                                            </div>
