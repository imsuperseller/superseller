...
function ThankYouContent() {
    ...
    const content = {
        audit: {
            ...
            nextStep: "Check your email (and spam folder) for a message from SuperSeller AI AI."
        },
        checklist: {
        ...
        default: {
            ...
            message: "Thank you for your interest in SuperSeller AI. We're excited to help you automate your business.",
