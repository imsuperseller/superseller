...
const SEED_TEMPLATES = [
    ...
    { id: 'U6EZ2iLQ4zCGg31H', name: 'Voice AI Lead Analyzer', category: 'Lead & Sales', price: 497, rating: 4.9, downloadCount: 203, readinessStatus: 'Active', showInMarketplace: true, tags: ['marketplace'], features: ['Voice Transcription', 'Buying Intent Scoring', 'CRM Integration'], tools: ['telnyx', 'workiz', 'openai'], outcomeHeadline: 'Scale Your Sales with Autonomous Voice AI Intelligence', description: 'Part of the SuperSeller AI Autonomous Secretary pillar.' },
