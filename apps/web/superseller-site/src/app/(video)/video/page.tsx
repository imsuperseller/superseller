    ...
    return (
        <div className="max-w-6xl mx-auto px-4 py-8">
            ...
            <div className="flex items-center justify-between mb-8">
                ...
                <Link
                    href="/video/create"
                    className="flex items-center gap-2 px-5 py-2.5 rounded-lg bg-[#f47920] hover:bg-[#f58a30] text-white font-medium transition-colors"
                >
            ...
            {!loading && !error && jobs.length === 0 && (
                <div className="rounded-2xl border border-dashed border-white/20 p-16 text-center">
                    <div className="w-16 h-16 rounded-2xl bg-[#f47920]/10 flex items-center justify-center mx-auto mb-6">
                        <Video className="w-8 h-8 text-[#f47920]" />
                    </div>
                    ...
                    <Link
                        href="/video/create"
                        className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-[#f47920] hover:bg-[#f58a30] text-white font-semibold transition-colors"
                    >
