            ...
            <div className="lg:col-span-5 space-y-12">
              ...
              <div className="p-10 rounded-[3rem] border border-white/5 bg-white/[0.01]">
                ...
                <div className="flex flex-wrap gap-4">
                  {[
                    { name: 'Instagram', href: 'https://www.instagram.com/superseller.agency/', icon: (
                    ...
                    { name: 'Facebook', href: 'https://www.facebook.com/SuperSellerAgencyAI', icon: (
                    ...
                    { name: 'TikTok', href: 'https://www.tiktok.com/@superseller09', icon: (
                    ...
                    { name: 'X', href: 'https://x.com/iamsuperseller', icon: (
                      <svg viewBox="0 0 24 24" className="w-4 h-4 fill-current"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                    )},
                    { name: 'YouTube', href: env.NEXT_PUBLIC_YOUTUBE_URL || 'https://youtube.com/@superseller', icon: (
