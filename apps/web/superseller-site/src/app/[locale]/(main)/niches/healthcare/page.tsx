...
export default function HealthcareNichePage() {
    ...
    const breadcrumbData = {
        itemListElement: [
            ...
            { '@type': 'ListItem', position: 3, name: 'Healthcare', item: 'https://superseller.agency/niches/healthcare' }
        ]
    };
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4">
                                    <Link href="/contact?niche=healthcare">
                                        <Button size="lg" className="h-14 px-8 font-bold" variant="supersellerSecondary">
                                            Book Medical Audit
                                        </Button>
                                    </Link>
