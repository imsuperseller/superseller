...
export const NICHES: Niche[] = [
  {
    ...
    metaTitle: 'SuperSeller AI for Realtors | AI Video Tours, 24/7 Call Answering, Social Media',
    metaDescription:
      'Stop paying $500 per listing video. SuperSeller AI\'s AI crew produces property tours from Zillow links, answers buyer calls 24/7, and posts across all your social channels.',
    locale: 'en',
    direction: 'ltr',
  },
  {
    ...
    metaTitle: 'SuperSeller AI for Locksmiths | 24/7 AI Call Answering, Video Marketing, Lead Generation',
    metaDescription:
      'Never lose a lockout call again. SuperSeller AI\'s AI crew answers emergency calls 24/7, creates marketing videos, and generates leads for your locksmith business.',
    locale: 'en',
    direction: 'ltr',
  },
  {
    ...
    metaTitle: 'SuperSeller AI for Restaurants | AI Reservations, Social Media, Video Marketing',
    metaDescription:
      'Fill empty tables without lifting a finger. SuperSeller AI\'s AI crew handles reservations, creates social content, and runs promotions for your restaurant.',
    locale: 'en',
    direction: 'ltr',
  },
  {
    ...
    metaTitle: 'SuperSeller AI for Contractors | AI Call Answering, Project Videos, Lead Generation',
    metaDescription:
      'Win more jobs while you\'re on the job. SuperSeller AI\'s AI crew answers calls, creates project videos, and delivers qualified leads for contractors.',
    locale: 'en',
    direction: 'ltr',
  },
  {
    ...
    metaTitle: 'SuperSeller AI for Auto Repair | AI Booking, Customer Education, Marketing',
    metaDescription:
      'Your shop runs even when you\'re under the hood. SuperSeller AI\'s AI crew books appointments, answers customer questions, and markets your auto repair shop.',
    locale: 'en',
    direction: 'ltr',
  },
  {
    ...
    metaTitle: 'SuperSeller AI for HVAC & Plumbing | 24/7 AI Dispatch, Marketing, Lead Generation',
    metaDescription:
      'Your HVAC and plumbing business, fully automated. SuperSeller AI\'s AI crew handles emergency calls, seasonal marketing, and lead generation.',
    locale: 'en',
    direction: 'ltr',
  },
  {
    ...
    metaTitle: 'SuperSeller AI for Insurance Agents | AI Video Explainers, Lead Pages, Social Content',
    metaDescription:
      'Close more policies with less cold calling. SuperSeller AI\'s AI crew creates explainer videos, builds lead pages, and nurtures prospects for insurance agents.',
    locale: 'en',
    direction: 'ltr',
  },
  {
    ...
    metaTitle: 'SuperSeller AI for Dental & Medical | AI Scheduling, Patient Videos, Practice Marketing',
    metaDescription:
      'Grow your practice without a marketing department. SuperSeller AI\'s AI crew handles appointment calls, creates patient education videos, and builds your online presence.',
    locale: 'en',
    direction: 'ltr',
  },
];
