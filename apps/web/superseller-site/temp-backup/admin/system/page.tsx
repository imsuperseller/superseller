          ...
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className={`px-2 py-1 text-xs font-medium rounded-full ${
                ...
                backupStatus.status === 'running' ? "bg-blue-100 style={{ color: 'var(--superseller-blue)' }}" :
                "style={{ backgroundColor: 'var(--superseller-bg-primary)' }} style={{ color: 'var(--superseller-red)' }}"
              }`}>
