...
export default function AgentsPage() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'stopped': return 'bg-superseller-card text-superseller-text';
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="rounded-lg border text-card-foreground shadow-sm border-superseller-cyan bg-superseller-bg-card shadow-superseller-glow-accent superseller-card-neon">
      ...
      <div className="rounded-lg border text-card-foreground shadow-sm border-superseller-cyan bg-superseller-bg-card shadow-superseller-glow-accent superseller-card-neon">
        <div className="flex flex-col space-y-1.5 p-6">
          <h3 className="text-2xl font-semibold leading-none tracking-tight text-superseller-text-primary flex items-center space-x-2">
