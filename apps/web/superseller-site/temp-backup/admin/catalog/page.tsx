...
export default function AgentCatalogPage() {
  ...
  const getCategoryBadge = (category: string) => {
    switch (category) {
      case 'content':
        return <Badge variant="supersellerPrimary">Content</Badge>;
      case 'social':
        return <Badge variant="supersellerSecondary">Social</Badge>;
      case 'automation':
        return <Badge variant="supersellerNeon">Automation</Badge>;
      case 'analytics':
        return <Badge variant="supersellerSuccess">Analytics</Badge>;
      case 'custom':
        return <Badge variant="supersellerWarning">Custom</Badge>;
      default:
        return <Badge variant="supersellerSecondary">{category}</Badge>;
    }
  };

  const getDeprecatedBadge = (isDeprecated: boolean) => {
    return isDeprecated ? (
      <Badge variant="supersellerError">Deprecated</Badge>
    ) : (
      <Badge variant="supersellerSuccess">Active</Badge>
    );
  };
            ...
            <TableBody>
              {filteredAgents.map((agent) => (
                <TableRow key={agent.key}>
                  ...
                  <TableCell>
                    <div className="flex items-center space-x-2">
                      <Button variant="supersellerSecondary" size="sm" title="View details">
                        <Eye className="h-4 w-4" />
                      </Button>
                      <Button variant="supersellerSecondary" size="sm" title="Edit definition">
                        <Edit className="h-4 w-4" />
                      </Button>
                      <Button variant="supersellerSecondary" size="sm" title="Bump version">
