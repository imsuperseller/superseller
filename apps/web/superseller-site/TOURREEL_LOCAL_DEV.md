...
```bash
cd apps/web/superseller-site && pnpm dev
```
...
3. **Start superseller-site**: `VIDEO_WORKER_URL=http://localhost:3001 pnpm dev`
...
| **S**tylize | Wireframes design system; SuperSeller AI brand (#fe3d51, #1eaef7); Stitch/21dev elements as needed |
...
- **SuperSeller AI brand**: `docs/reference/brand/`, .cursorrules — primary #fe3d51, accent #1eaef7
...
**Don’t redesign from scratch.** Use SuperSeller AI design; optimize and adjust. For new elements (e.g. 21dev), get components and integrate.
...
- [ ] superseller-site running with correct `VIDEO_WORKER_URL`
