...
| `N8N_FULFILLMENT_WEBHOOK_URL` | Fulfillment orchestration | Default: `https://n8n.superseller.agency/webhook/fulfillment-orchestrator` |
| `N8N_OPTIMIZER_WEBHOOK` | Provisioning service | Template optimization |
| `N8N_INDEXING_WEBHOOK_URL` | Knowledge indexing | Default: `https://n8n.superseller.agency/webhook/knowledge-indexing` |
