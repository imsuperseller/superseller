...
- [PIPELINE_SPEC.md](PIPELINE_SPEC.md) — pipeline architecture, Kling 3, Nano Banana, Kie
...
| UI Wireframes | legacy_archive/claude ref/ui wireframe.md | Flow, components | Frontend not built |
