...
- `blueprint.md` — Original architectural vision (conceptual)
- `implementation specs.md` — Detailed build order (contains legacy FAL/Veo; see top notice)
- `playbook prompt.md` — Creative prompts and sequences
