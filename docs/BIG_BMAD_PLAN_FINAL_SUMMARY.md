...
- **Webflow**: API error (400 status code - invalid credentials)
...
2. **Fix Webflow Integration**:
   - Update Webflow API credentials
   - Verify site ID
   - Test API endpoints
...
1. **Connect All Systems**:
   - Airtable ↔ n8n ↔ Email Personas ↔ Webflow ↔ Lightrag
...
3. **Fix Webflow Integration**: Update API credentials
