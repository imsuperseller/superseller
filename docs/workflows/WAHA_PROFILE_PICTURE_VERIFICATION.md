...
- **URL**: `http://173.254.201.134:8080/novok-profile-picture.jpg`
- **Status**: ✅ HTTP 200 OK
...
**Profile Picture URL**: `http://173.254.201.134:8080/novok-profile-picture.jpg`  
...
**Image URL**: `http://173.254.201.134:8080/novok-profile-picture.jpg`  
...
```bash
ssh root@173.254.201.134 'pkill -f "python3 -m http.server 8080"'
```
