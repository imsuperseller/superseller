...
curl -s -H "x-api-key: 4fc7e008d7d24fc995475029effc8fa8" \
  http://173.254.201.134:3000/api/sessions/default | python3 -m json.tool | grep -A 5 "profilePicture"

# Check tax4us session profile picture
curl -s -H "x-api-key: 4fc7e008d7d24fc995475029effc8fa8" \
  http://173.254.201.134:3000/api/sessions/tax4us | python3 -m json.tool | grep -A 5 "profilePicture"

# Check meatpoint session profile picture
curl -s -H "x-api-key: 4fc7e008d7d24fc995475029effc8fa8" \
  http://173.254.201.134:3000/api/sessions/meatpoint | python3 -m json.tool | grep -A 5 "profilePicture"
```
...
```bash
curl -s -H "x-api-key: 4fc7e008d7d24fc995475029effc8fa8" \
  http://173.254.201.134:3000/api/sessions/default | python3 -m json.tool | grep -A 10 "webhook"
```
...
**Steps**:
1. Check workflow status: `http://173.254.201.134:5678/workflow/nZJJZvWl0MBe3uT4`
...
**Environment**: Production (173.254.201.134)
