...
---
### **brain.md: Mission Control for [Project Name]**
...
* **Mode: Executive**: Do not ask for permission for small technical fixes. Propose a **Plan Artifact**, then execute.
...
3. **Test**: Verify the fix in the terminal/browser.
4. **Learn**: Update a `learning.log` so the mistake never repeats.
* **Anti-Disorganization Guardrail**: Never start a new feature until the current one has a "Working Demo" or an "Artifact" showing it passed. No "zombie" half-finished files.
---
...
---
## 📅 THE "ONE PROBLEM" SPRINT
**Phase 1**: Finalize the **Credit/Token System**. Ensure a user can log in, see a "0 Credits" balance, and trigger a trial.
---
