...
**Purpose**: Technical reference and operational guidelines for Antigravity when working with n8n in the Rensto ecosystem.

---

## 🏗️ SYSTEM ARCHITECTURE & ACCESS

### **Primary n8n Instance (Rensto VPS)**
...
- **Vercel Integration**: Ensure n8n webhooks are correctly targeted by Vercel API routes in `apps/web/rensto-site/src/app/api/webhooks/`.
