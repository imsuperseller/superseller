...
### 1. Short-Form Blitz (Building Trust & Attention)
- **Platforms**: TikTok, Instagram Reels, YouTube Shorts.
- **Frequency**: 2x Daily (Total 14 posts/week).
- **Format**: 15-60 second clips using "Copy-the-Template" logic.
- **Milestone**: The "100-Post Commitment". No judging results until post #101.
- **Hook Strategy**: Use the **4 Pillars** as hooks (e.g., "How I built an AI Voice Agent that replaces a $4k/mo secretary").

### 2. LinkedIn Thought Leadership (Credibility)
- **Frequency**: 3x Weekly.
- **Tone**: Mature, problem-solver focus. 
- **The "No Camera" Advantage**: Text-based posts focused on ROI and "Problem-Solution" patterns for SMBS ($2M-$10M ARR).

## The "Warm Network" Script (Day 1 Outreach)
