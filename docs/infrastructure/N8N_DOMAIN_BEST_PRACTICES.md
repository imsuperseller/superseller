...
- **Previous IP**: `173.254.201.134` (Old VPS - decommissioned)
...
const N8N_API_URL = 'http://173.254.201.134:5678';
```
...
```typescript
// Before
const N8N_URL = process.env.N8N_API_URL || 'http://173.254.201.134:5678';
