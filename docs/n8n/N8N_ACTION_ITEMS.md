...
**Fix**:
1. Open workflow: http://173.254.201.134:5678/workflow/8Fls0QPWnGyTkTz5
...
**Fix**:
1. Open workflow: http://173.254.201.134:5678/workflow/ipP7GRTeJrpwxyQx
...
- ✅ n8n instance: Running (http://173.254.201.134:5678)
...
### **If You Need Help**:
1. **n8n Issues**: Check n8n UI at http://173.254.201.134:5678
...
curl "http://173.254.201.134:5678/api/v1/workflows/[WORKFLOW_ID]" \
  -H "X-N8N-API-KEY: [KEY]" \
