...
**Steps**:
1. Open workflow in n8n UI: http://173.254.201.134:5678/workflow/8Fls0QPWnGyTkTz5
...
```bash
curl -s "http://173.254.201.134:5678/api/v1/workflows/8Fls0QPWnGyTkTz5" \
...
WEBHOOK_URL="http://173.254.201.134:5678/webhook/customer-update"
