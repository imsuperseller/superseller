# 🚀 HeyGen Quick Start Guide - 2026

**Date**: December 2025  
**Status**: ✅ **UPDATED WITH LATEST FEATURES**  
**Tool**: HeyGen Video Agent (Automated Video Generation)

---

## ⚡ **QUICK START: CREATE YOUR FIRST VIDEO IN 15 MINUTES**

### **Step 1: Access HeyGen Video Agent**
1. Go to https://heygen.com
2. Login to your account
3. Click "Create Video" → "Video Agent"
4. Select "Generate from Prompt"

### **Step 2: Use Optimized Prompt Template**

Copy this template and fill in your details:

```
VIDEO TYPE: [Hero Background / Service Card / Demo / Testimonial]
DURATION: [15s / 30s / 60s / 90s / 2min]
...
SCRIPT:
[Your complete script here - 150-200 words for 60s video]

VISUAL REQUIREMENTS:
- Background: [Describe what you want - e.g., "Split-screen showing manual chaos vs automated control"]
- Graphics: [List graphics needed - e.g., "Show Gmail inbox, Google Sheets, WhatsApp icons"]
- Animations: [Describe animations - e.g., "Transition from chaos to organized dashboard"]
- Logo Placement: Start (2s) and end (2s)
...
1. Paste your optimized prompt
2. Select "Rensto" brand (Brand Shuffle auto-applies)
3. Click "Generate Video"
4. Wait 2-5 minutes

### **Step 4: Review & Export**
1. Review generated video
2. Make minor adjustments if needed (HeyGen handles most automatically)
3. Export 1080p
4. Upload to YouTube (unlisted)
5. Get video ID for integration

---

## 🎯 **READY-TO-USE PROMPTS**

### **Custom Solutions Hero** (60s) - TOP PRIORITY
...
- Avatars (based on script context)
- Backgrounds (based on visual requirements)
- Graphics (based on script mentions)
- Animations (based on transitions described)
- Logo placement (based on timing specified)
- Brand colors/fonts (via Brand Shuffle)

### **✅ You Just Need To**:
- Write comprehensive prompt (script + visual requirements)
- Select brand (Rensto)
...
|------|---------|---------|---------|
| Script writing | 30 min | 15 min | 50% |
| Element selection | 60 min | 0 min | 100% |
| Background/graphics | 45 min | 0 min | 100% |
| Logo placement | 15 min | 0 min | 100% |
| Editing/timing | 30 min | 5 min | 83% |
| **Total** | **2-3 hours** | **15-20 min** | **80%** |

---

## 🎯 **PRIORITY ORDER**

**Week 1** (Essential Hero Videos):
1. Custom Solutions Hero (60s)
2. Marketplace Hero (60s)
3. Subscriptions Hero (60s)
4. Ready Solutions Hero (30s)

**Week 2** (Demo Videos):
5. Marketplace Installation Demo (90s)
6. Subscriptions Lead Generation Demo (90s)

**Week 3+** (Additional Videos):
7. Service Card Videos (15s each)
8. Industry-Specific Videos (30s each)

---

## 📚 **FULL DOCUMENTATION**

- **Complete Guide**: `/docs/website/HEYGEN_2026_AUTOMATED_VIDEO_GUIDE.md`
- **Original Scripts**: `/webflow/HEYGEN_VIDEO_SCRIPTS.md`
- **Video Strategy**: `/docs/website/VIDEO_STRATEGY_BY_PAGE_NOV16.md`

---

**Ready to create? Start with Custom Solutions Hero Video using the prompt above!**
