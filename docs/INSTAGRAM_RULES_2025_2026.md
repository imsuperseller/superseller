# Instagram Rules, Limits & Best Practices (2025-2026)

**Research Date**: March 9, 2026
**Purpose**: Authoritative reference for Instagram content strategy (Elite Pro Remodeling + future clients)
...
## 2. Hashtag Rules (2025-2026)

### CRITICAL UPDATE: 5 Hashtag Maximum (December 2025)

**Official announcement from @creators (Dec 18, 2025)**: Instagram now caps hashtags at **5 per post or Reel**. This is a HARD limit — hashtags beyond 5 are either ignored or the post is blocked until corrected.

> "We find that using fewer (up to 5), more targeted hashtags rather than many generic ones can improve both your content's performance and people's experience on Instagram." — Instagram official post
...
- **How to check**: Search the hashtag in Instagram — if no results or very few posts appear, it is likely banned
- **Consequence of using banned hashtags**: Posts hidden from non-followers, reduced reach, potential account restriction
...
- **Carousels**: Same 5-cap applies to the caption
...
4. **CTAs**: Place calls-to-action ("Save this!", "Share with a friend", "Comment below") toward the end but within the visible portion if possible
...
- **Cannot be edited after publishing** — choose wisely
...
- **Workaround**: Use royalty-free music, original audio, or Meta Sound Collection
...
- **Left buffer**: 60px
- **Right buffer**: 120px
- **Font size**: 42px minimum for readability
- **Line length**: Under 30 characters per line
...
- **16:9 (landscape)**: Supported but displayed with black bars
...
- **Emoji slider** (sliding scale reaction)
- **Countdown** (event timer)
- **Add Yours** (viral chain sticker)
- **Music** (song clips with lyrics)
- **Location** tag
- **Mention** (@username)
- **Link sticker** (available to ALL accounts — no follower minimum)
- **Product tags** (for shopping-enabled accounts)
- **AI stickers** (new in 2025)
...
- **Reels specifically**: 6-9 PM (viewed as leisure entertainment)
...
- **Safe cross-posting**: Remove all watermarks, resize natively, add platform-specific elements
...
- Reels analytics (plays, accounts reached, likes, comments, shares, saves)
...
## 10. Instagram Graph API Capabilities (2025-2026)
...
```
POSTING LIMITS:
  Feed:    1-2/day (3-5/week optimal)
  Reels:   2-4/week
  Stories: 3-7/day (100 max)
  Carousel: 1-2/week (highest engagement!)

HASHTAGS:
  Max: 5 (HARD LIMIT since Dec 2025)
  Place in: Caption (not first comment)
  Type: Targeted, niche-specific (NOT #explore #reels)

CAPTIONS:
  Max: 2,200 chars
  Visible before "more": 125 chars (feed), 55 chars (Reels)
  Hook: First 125 chars = most important

REELS:
  Best length: 7-30 sec (discovery), 60-90 sec (depth)
  Max length: 20 minutes
  Hook: First 3 seconds = critical
  Music: Business accounts = royalty-free ONLY
  Cover: 1080x1920, center 1080x1080 for grid crop

CAROUSEL:
  Max slides: 20
  Best ratio: 4:5 (1080x1350)
  All slides: SAME aspect ratio
  Mix: Photos + videos allowed

ALGORITHM PRIORITIES (2026):
  1. Watch time (especially first 3 sec)
  2. DM shares (strongest for new reach)
  3. Likes per reach
  4. Saves > Comments

BEST TIMES (Home Services):
  Weekday evenings: 7-9 PM
  Weekend mornings: 9-11 AM Sat
...
- [Meta Stories Publishing Blog Post](https://developers.facebook.com/blog/post/2023/05/16/introducing-stories-publishing-to-the-content-publishing-api-on-instagram/)
- [Instagram Reel Aspect Ratios (Help Center)](https://help.instagram.com/1038071743007909)
- [Instagram Music Access for Business](https://help.instagram.com/402084904469945/)
- [Instagram Business/Creator Accounts](https://help.instagram.com/138925576505882)
...
- [Social Media Today — Hashtag Limit Announcement](https://www.socialmediatoday.com/news/instagram-implements-new-limits-on-hashtag-use/808309/)
- [TechBuzz — Hashtag Cap Details](https://www.techbuzz.ai/articles/instagram-caps-hashtags-at-five-to-combat-spam)
- [Metricool — Instagram Limits 2026](https://metricool.com/instagram-limits/)
- [Social Champ — Instagram Limits Guide](https://www.socialchamp.com/blog/instagram-limits/)
- [Inro Social — Reels Time Limit 2026](https://www.inro.social/blog/instagram-reels-can-now-be-20-minutes-long-new-time-limit-explained-2025)
- [Dataslayer — Algorithm 2025 (Mosseri Confirmed)](https://www.dataslayer.ai/blog/instagram-algorithm-2025-complete-guide-for-marketers)
...
- [Elfsight — Graph API Developer Guide 2026](https://elfsight.com/blog/instagram-graph-api-complete-developer-guide-for-2026/)
- [Shopify — Best Time to Post 2026](https://www.shopify.com/blog/time-post-instagram)
- [Hopper HQ — Posting Frequency 2026](https://www.hopperhq.com/blog/instagram-posting-frequency-2026/)
- [Kicksta — Banned Hashtags List](https://kicksta.co/blog/a-complete-list-of-banned-hashtags-you-should-avoid)
- [MetaHashtags — Daily Updated Banned List](https://metahashtags.com/banned-hashtags/)
