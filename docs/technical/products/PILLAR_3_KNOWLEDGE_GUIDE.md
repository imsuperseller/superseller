...
The **Knowledge Engine** is the "Brain" of the Rensto ecosystem. It powers all RAG (Retrieval-Augmented Generation) capabilities, ensuring that AI responses are grounded in verified data, documents, and web research rather than hallucinations.
...
- **Active Workflow**: Integrated into `INT-WHATSAPP-ROUTER-OPTIMIZED` ([1LWTwUuN6P6uq2Ha](https://n8n.rensto.com/workflow/1LWTwUuN6P6uq2Ha)).
...
- **YouTube AI Clone** ([5pMi01SwffYB6KeX](https://n8n.rensto.com/workflow/5pMi01SwffYB6KeX)): Extracts "wisdom" from video content for reprocessing.
- **CRO Insights Bot** ([vCxY2DXUZ8vUb30f](https://n8n.rensto.com/workflow/vCxY2DXUZ8vUb30f)): Specialized in web-research for Conversion Rate Optimization.
...
- **PDF Sales Agent (Old Vector Store)** ([2IupcJdCKDv4LcoE](https://n8n.rensto.com/workflow/2IupcJdCKDv4LcoE)): Inactive. Replaced by the Gemini/LightRAG combo for better accuracy.
