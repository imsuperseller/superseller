...
async function replaceWithNativeGeminiMCP() {
    ...
    try {
        ...
        const workflow = await useMcpTool('superseller-n8n-unified', 'n8n_get_workflow', { id: WORKFLOW_ID });
        ...
        await useMcpTool('superseller-n8n-unified', 'n8n_update_workflow', { id: WORKFLOW_ID, updates: { active: false } });
        ...
        const updatedWorkflow = await useMcpTool('superseller-n8n-unified', 'n8n_update_workflow', {
            id: WORKFLOW_ID,
        ...
        await useMcpTool('superseller-n8n-unified', 'n8n_update_workflow', { id: WORKFLOW_ID, updates: { active: true } });
        console.log('✅ Workflow reactivated.');

        // 9. Verify the native Gemini node
        console.log('🔍 Verifying the native Gemini node...');
        const verifiedWorkflow = await useMcpTool('superseller-n8n-unified', 'n8n_get_workflow', { id: WORKFLOW_ID });
