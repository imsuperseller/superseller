...
> **Source of Truth for SuperSeller AI's visual identity and component patterns.**

---

## Brand Aesthetics
- **Theme**: "Neon/Dark" – Deep blues/purples with high-contrast cyan and red accents.
- **Primary Colors**: `#06b6d4` (Cyan), `#fe3d51` (SuperSeller AI Red), `#0f0c29` (Background).
...
## Key Files
- [button-enhanced.tsx](file:///Users/shaifriedman/New%20SuperSeller AI/superseller/apps/web/superseller-site/src/components/ui/button-enhanced.tsx)
- [card-enhanced.tsx](file:///Users/shaifriedman/New%20SuperSeller AI/superseller/apps/web/superseller-site/src/components/ui/card-enhanced.tsx)
