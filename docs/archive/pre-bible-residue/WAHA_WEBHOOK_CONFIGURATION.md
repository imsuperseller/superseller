...
- **Webhook URL**: `http://172.245.56.50:5678/webhook/976a4187-04c0-458b-b9ba-c7af75ed5de0/waha`

**WAHA Instance**:
- **URL**: `http://172.245.56.50:3000`
...
```bash
curl -X POST "http://172.245.56.50:3000/api/sessions/rensto-support" \
  -H "x-api-key: 4fc7e008d7d24fc995475029effc8fa8" \
  -H "Content-Type: application/json" \
  -d '{
    "webhook": {
      "url": "http://172.245.56.50:5678/webhook/976a4187-04c0-458b-b9ba-c7af75ed5de0/waha",
      "events": [
        "session.status",
        "message",
        "message.any",
...
```bash
curl -X POST "http://172.245.56.50:3000/api/webhooks" \
  -H "x-api-key: 4fc7e008d7d24fc995475029effc8fa8" \
  -H "Content-Type: application/json" \
  -d '{
    "url": "http://172.245.56.50:5678/webhook/976a4187-04c0-458b-b9ba-c7af75ed5de0/waha",
...
```bash
curl -X GET "http://172.245.56.50:3000/api/sessions/rensto-support" \
  -H "x-api-key: 4fc7e008d7d24fc995475029effc8fa8"
```
...
2. **Check n8n workflow execution**: `http://172.245.56.50:5678/executions`
...
- Check n8n webhook logs: `http://172.245.56.50:5678/webhook/976a4187-04c0-458b-b9ba-c7af75ed5de0/waha`
...
3. Test webhook URL directly: `curl -X POST http://172.245.56.50:5678/webhook/976a4187-04c0-458b-b9ba-c7af75ed5de0/waha`
...
- **n8n Workflow**: `http://172.245.56.50:5678/workflow/eQSCUFw91oXLxtvn`
...
curl -X POST "http://172.245.56.50:3000/api/sessions/rensto-support" \
  -H "x-api-key: 4fc7e008d7d24fc995475029effc8fa8" \
  -H "Content-Type: application/json" \
  -d '{"webhook":{"url":"http://172.245.56.50:5678/webhook/976a4187-04c0-458b-b9ba-c7af75ed5de0/waha","events":["message","message.any","session.status"],"retries":3}}'
```
