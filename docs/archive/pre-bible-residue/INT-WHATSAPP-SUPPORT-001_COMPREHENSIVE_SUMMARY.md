...
- **n8n instance**: `http://172.245.56.50:5678` (RackNerd VPS)
- **WAHA server**: `http://172.245.56.50:3000` (WhatsApp HTTP API)
...
- **WAHA API endpoint**: `http://172.245.56.50:3000/api/sendVoice`
