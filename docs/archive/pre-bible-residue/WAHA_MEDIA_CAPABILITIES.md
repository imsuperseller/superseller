...
curl -X POST \
  ...
  http://172.245.56.50:3000/api/sendImage
```
...
curl -X POST \
  ...
  http://172.245.56.50:3000/api/sendVideo
```
...
curl -X POST \
  ...
  http://172.245.56.50:3000/api/sendFile
```
...
curl -X POST \
  ...
  http://172.245.56.50:3000/api/sendVoice
```
...
curl -X POST \
  ...
  http://172.245.56.50:3000/api/sendLocation
```
