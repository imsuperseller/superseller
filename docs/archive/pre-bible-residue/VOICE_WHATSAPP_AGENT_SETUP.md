...
**ID**: `3OukCjHVvBXiXr6u`  
**URL**: `http://172.245.56.50:5678/workflow/3OukCjHVvBXiXr6u`
...
**Check Credentials**:
- Go to: `http://172.245.56.50:5678/credentials`
...
1. Open workflow: `http://172.245.56.50:5678/workflow/3OukCjHVvBXiXr6u`
2. Click on **"WAHA Trigger"** node
3. Copy the **Webhook URL** (should be something like):
   ```
   http://172.245.56.50:5678/webhook/{webhook-id}/waha
   ```

**Or check webhook ID from node**:
- The webhook ID is stored in the node's `webhookId` parameter
- Format: `http://172.245.56.50:5678/webhook/{webhookId}/waha`
...
curl -X POST \
  ...
  -d '{
    "url": "http://172.245.56.50:5678/webhook/{webhook-id}/waha",
    "events": ["message"]
  }' \
  http://172.245.56.50:3000/api/webhooks
```
...
1. Go to: `http://172.245.56.50:3000/dashboard`
...
1. Go to: `http://172.245.56.50:5678/workflow/3OukCjHVvBXiXr6u`
...
**Workflow**: `http://172.245.56.50:5678/workflow/3OukCjHVvBXiXr6u`  
**WAHA API**: `http://172.245.56.50:3000`  
