...
**Current**: `http://172.245.56.50:5678` (HTTP only)
...
**Before**: `http://172.245.56.50:5678`
...
The setup is done on your server (VPS at 172.245.56.50), not via API/MCP.
...
**Test it**:
1. Go to: http://172.245.56.50:5678/workflow/cJbG8MpomtNrR1Sa
...
- **Requires SSH access** to your server at 172.245.56.50
