...
```bash
curl -H "x-api-key: 4fc7e008d7d24fc995475029effc8fa8" \
     http://172.245.56.50:3000/api/sessions/default/qr
```
...
**Try Dashboard URL**:
```
http://172.245.56.50:3000/dashboard
```
...
2. **HTTP Request Node**:
   - Method: `POST`
   - URL: `http://172.245.56.50:3000/api/sessions/create`
   - Headers:
