...
1. Open workflow: `http://172.245.56.50:5678/workflow/eQSCUFw91oXLxtvn`
...
5. **Webhook URL** will be: `http://172.245.56.50:5678/webhook/rensto-support`
...
```javascript
// POST to webhook
const response = await fetch('http://172.245.56.50:5678/webhook/rensto-support', {
  method: 'POST',
