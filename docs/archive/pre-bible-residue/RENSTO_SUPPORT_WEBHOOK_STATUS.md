...
**Issue**: Webhook URL uses HTTPS domain (`n8n.rensto.com`) but n8n is on HTTP IP (`172.245.56.50:5678`)

**Possible Scenarios**:
1. ✅ **DNS points to n8n**: `n8n.rensto.com` → `172.245.56.50:5678` (via reverse proxy)
...
**Expected**: Should resolve to `172.245.56.50` or proxy IP
...
**URL**: `http://172.245.56.50:5678/executions`
...
curl -X PUT "http://172.245.56.50:3000/api/sessions/rensto-support/webhook" \
...
```bash
curl -X POST "http://172.245.56.50:3000/api/sessions/rensto-support/restart" \
  -H "x-api-key: 4fc7e008d7d24fc995475029effc8fa8"
```
...
**In n8n UI**:
1. Deactivate workflow: `http://172.245.56.50:5678/workflow/eQSCUFw91oXLxtvn`
2. Wait 5 seconds
3. Activate workflow
