...
**Migration**: Old VPS (172.245.56.50) → New VPS (172.245.56.50)  
...
1. ✅ `infra/mcp-servers/n8n-mcp-wrapper/n8n-rensto-wrapper.cjs`
   - Updated: `N8N_API_URL` from `http://172.245.56.50:5678` → `http://n8n.rensto.com`

2. ✅ `rensto-marketplace/plugins/rensto-n8n-agents/mcpServers/n8n-unified-server.js`
   - Updated: Default URL from `http://172.245.56.50:5678` → `http://n8n.rensto.com`

3. ✅ `rensto-marketplace/plugins/rensto-n8n-agents/mcpServers/n8n-unified.json`
   - Updated: `N8N_RENSTO_VPS_URL` from `http://172.245.56.50:5678` → `http://n8n.rensto.com`

### **Scripts & Configuration**
4. ✅ `scripts/n8n/n8n-config.js`
   - Updated: Rensto instance URL from `http://172.245.56.50:5678` → `http://n8n.rensto.com`

### **Vercel API Routes** (apps/web/rensto-site)
5. ✅ `src/app/api/stripe/webhook/route.ts`
   - Updated: `N8N_URL` from `http://172.245.56.50:5678` → `http://n8n.rensto.com`
   - **Impact**: Stripe webhook triggers to n8n workflows

6. ✅ `api-backup/api/n8n/health/route.ts`
   - Updated: `N8N_BASE_URL` from `http://172.245.56.50:5678` → `http://n8n.rensto.com`

7. ✅ `api-backup/api/analytics/facebook-scraping/[orgId]/route.ts`
   - Updated: Default `n8nUrl` from `http://172.245.56.50:5678` → `http://n8n.rensto.com`

8. ✅ `api-backup/api/agents/[id]/run/route.ts`
   - Updated: `n8nWebhookUrl` from `http://172.245.56.50:5678/webhook/facebook-scraper` → `http://n8n.rensto.com/webhook/facebook-scraper`

### **Admin Dashboard**
9. ✅ `apps/web/admin-dashboard/src/app/api/n8n/update/route.ts`
   - Updated: `n8nUrl` from `http://172.245.56.50:5678` → `http://n8n.rensto.com`
