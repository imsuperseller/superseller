...
2. [Floorplan Analysis Prompts](#2-floorplan-analysis-prompts)
3. [Tour Sequence Builder Prompts](#3-tour-sequence-builder-prompts)
4. [Video Clip Prompts — Master Templates](#4-video-clip-prompts)
5. [Room-Type Prompt Library](#5-room-type-prompt-library)
6. [Transition-Type Prompt Modifiers](#6-transition-type-prompt-modifiers)
7. [Property Style Prompt Modifiers](#7-property-style-prompt-modifiers)
8. [Negative Prompts](#8-negative-prompts)
9. [Music Generation Prompts](#9-music-generation-prompts)
10. [Fallback Prompts (No Floorplan)](#10-fallback-prompts)
11. [Prompt Assembly Logic](#11-prompt-assembly-logic)
12. [Quality Control Prompts](#12-quality-control-prompts)
13. [Tuning Guide & Known Failure Modes](#13-tuning-guide)
14. [Prompt Version Registry](#14-prompt-version-registry)
---
...
```typescript
export const ROOM_DESCRIPTIONS: Record typical_features: string;
camera_focus: string;
...
```typescript
export const TRANSITION_MODIFIERS: Record camera_instruction: string;
...
```typescript
export const STYLE_MODIFIERS: Record interior_palette: string;
...
```typescript
export const ROOM_NEGATIVE_ADDITIONS: Record = {
...
```typescript
export const DEFAULT_SEQUENCES: Record = {
"house_3bed_2bath": [
