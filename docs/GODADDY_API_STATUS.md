...
|------|------|-------|-----|-------------|
| `ben-ginati` | CNAME | `rensto-business-system.vercel.app` | 3600 | Ben Ginati customer portal |
| `shelly-mizrahi` | CNAME | `rensto-business-system.vercel.app` | 3600 | Shelly Mizrahi customer portal |
| `www` | CNAME | `rensto-business-system.vercel.app` | 3600 | WWW subdomain |
