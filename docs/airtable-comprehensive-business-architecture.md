...
- Platform (Single select: Airtable, n8n, Zapier, Webflow, QuickBooks, Slack)
- Status (Single select: Active, Inactive, Development, Testing)
...
- System (Single select: Airtable, n8n, Webflow, Custom)
...
- System (Single select: Airtable, n8n, Webflow, Server, Database)
...
- System (Single select: Airtable, n8n, Webflow, Database, Files)
