...
- **Current**: 6 MCP servers (n8n, stripe, analytics, email, financial, ai-workflow)
...
Customer Onboarding Workflow:
  ...
  5. n8n-mcp-server: Set up customer workflows
...
Ben's WordPress Agent Development:
  ...
  5. n8n-mcp-server: Deploy WordPress workflows
```
...
Shelly's Excel Processing Development:
  ...
  5. n8n-mcp-server: Deploy Excel workflows
```
