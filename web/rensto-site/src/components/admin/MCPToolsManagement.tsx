...
export default function MCPToolsManagement() {
  const [mcpTools, setMcpTools] = useState<MCPToolCategory[]>([
    ...
    {
      name: "Rensto Data Management",
      totalRevenue: 725,
      totalUsage: 520,
      tools: [
        {
          id: 'manage_rensto_data',
          name: 'Manage Rensto Data',
          category: 'Rensto Data Management',
          status: 'active',
          usage: 250,
          revenue: 362.5,
          lastUsed: '2025-08-19T03:00:00Z',
          description: 'Manage Rensto system data with backup and export capabilities'
        },
        {
          id: 'analyze_rensto_performance',
          name: 'Analyze Rensto Performance',
          category: 'Rensto Data Management',
          status: 'active',
          usage: 270,
          revenue: 362.5,
          lastUsed: '2025-08-19T02:55:00Z',
          description: 'Analyze Rensto system performance with recommendations'
        }
      ]
    },
    {
