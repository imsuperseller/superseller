  ...
  "rounded-lg border bg-card text-card-foreground shadow-sm",
  {
    variants: {
      variant: {
        ...
        renstoGlow: "border-rensto-blue bg-rensto-bg-card shadow-rensto-glow-secondary rensto-animate-pulse",
      },
    },
    defaultVariants: {
      variant: "default",
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn("text-sm text-rensto-text-secondary", className)}
    {...props}
  />
))
