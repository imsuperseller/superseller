              ...
              <GlassCard>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <h4 className="text-rensto-text font-medium">Recent Profiles</h4>
                    ...
                    <div className="space-y-2">
                      {[
                        { name: 'Cohen Family', members: 5, date: '2025-01-18', status: 'completed' },
                        { name: 'Levy Family', members: 4, date: '2025-01-17', status: 'completed' },
                        { name: 'Rosen Family', members: 6, date: '2025-01-16', status: 'completed' },
                      ].map((profile, index) => (
                        <div key={index} className="flex items-center justify-between p-3 bg-rensto-card/30 rounded">
                          <div className="flex items-center space-x-3">
                            <Users className="w-5 h-5 text-rensto-cyan" />
                            <div>
                              <p className="text-rensto-text font-medium">{profile.name}</p>
                              <p className="text-sm text-rensto-text/70">{profile.members} members • {profile.date}</p>
                            </div>
                          </div>
                          <div className="flex items-center space-x-2">
                            <Badge variant="renstoSuccess" className="rensto-badge">
