...
export default function CustomersPage() {
  ...
  const sendCustomerEmail = (customer: Customer) => {
    window.open(`mailto:${customer.email}?subject=Rensto Support`, '_blank');
  };

  const getStatusColor = (status: string) => {
    switch (status) {
      case 'active': return 'bg-green-100 text-green-800';
      case 'inactive': return 'bg-rensto-card text-rensto-text';
    ...
    return (
      <div className="container mx-auto py-6">
        <div className="flex items-center justify-center h-64">
          <div className="rensto-animate-glow rounded-full h-8 w-8 border-b-2 border-gray-900"></div>
        </div>
      </div>
    );
  }
    ...
    <div className="container mx-auto py-6 space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-rensto-text/70 mt-2">Manage customer accounts, portals, and support</p>
        </div>
        <div className="flex gap-3">
          ...
          <Button variant="renstoPrimary" className="flex items-center gap-2 rensto-button">
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
              ...
              <div key={customer._id} className="flex items-center justify-between p-6 border rounded-lg">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-rensto-text/70">{customer.email}</p>
                    ...
                    {customer.agents && customer.agents.length > 0 && (
                      <div className="mt-2">
                        <p className="text-xs text-rensto-text/60">
            ...
            {customers.length === 0 && (
              <div className="text-center py-8 text-rensto-text/60">
      ...
      {selectedCustomer && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-rensto-card rounded-lg p-6 max-w-2xl w-full mx-4 max-h-[80vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="font-medium text-rensto-text">Personal Information</h3>
              ...
              {selectedCustomer.organization && (
                <div>
                  <h3 className="font-medium text-rensto-text">Organization</h3>
                  <div className="mt-2 space-y-2">
              ...
              {selectedCustomer.agents && selectedCustomer.agents.length > 0 && (
                <div>
                  <h3 className="font-medium text-rensto-text">Agents</h3>
                  <div className="mt-2 space-y-2">
                    {selectedCustomer.agents.map((agent) => (
                      <div key={agent._id} className="flex items-center justify-between p-2 bg-rensto-background rounded">
