...
export default function AddCustomerPage() {
        ...
        <Card className="border-green-200 bg-green-50">
          <CardContent className="pt-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <h3 className="font-medium style={{ color: 'var(--rensto-blue)' }} mb-2">Next Steps</h3>
              <ul className="style={{ color: 'var(--rensto-blue)' }} text-sm space-y-1">
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Error Alert */}
      {errors.general && (
        <Card className="border-red-200 style={{ backgroundColor: 'var(--rensto-bg-primary)' }}">
          <CardContent className="pt-6">
            <div className="flex items-center space-x-3">
              <AlertCircle className="h-5 w-5 style={{ color: 'var(--rensto-red)' }}" />
              <span className="style={{ color: 'var(--rensto-red)' }}">{errors.general}</span>
            </div>
          </CardContent>
        </Card>
      )}
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                ...
                />
                {errors.name && (
                  <p className="mt-1 text-sm style={{ color: 'var(--rensto-red)' }}">{errors.name}</p>
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.email && (
                  <p className="mt-1 text-sm style={{ color: 'var(--rensto-red)' }}">{errors.email}</p>
                )}
              </div>
              ...
              <div>
                ...
                />
                {errors.company && (
                  <p className="mt-1 text-sm style={{ color: 'var(--rensto-red)' }}">{errors.company}</p>
                )}
              </div>
              ...
              <div className="space-y-3">
                <label className="flex items-center space-x-3">
                  <input
                    ...
                    className="rounded border-gray-300 style={{ color: 'var(--rensto-blue)' }} focus:ring-blue-500"
                  />
                  <div>
        ...
        <div className="flex justify-end space-x-4 pt-6 border-t">
          ...
          >
            {loading ? (
              <>
                <Loader2 className="mr-2 h-4 w-4 rensto-animate-glow" />
                Creating...
              </>
            ) : (
              <>
