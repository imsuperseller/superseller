 ...
 * This script imports all the lost credentials back into n8n
 */
...
console.log('🔧 N8N CREDENTIALS IMPORT SCRIPT');
console.log('=================================\n');

console.log(`📋 Found ${credentials.length} credentials to import:`);
...
console.log('✅ Deleted 10 duplicate workflows');
console.log('✅ Kept essential active workflows');
console.log('✅ Reduced workflow count from 56 to ~46');

console.log('\n📊 RESTORATION PROGRESS:');
console.log('✅ Backup created');
console.log('✅ Workflow cleanup completed');
console.log('🔄 Credentials import ready');
