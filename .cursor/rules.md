...
7) **No spaces in file/dir names**. Use kebab-case. Move "Examples/ Shelly Mizrahi" to examples/shelly-mizrahi.
8) **Do not write to Airtable/Webflow as sources of truth**. Postgres is SoT; other systems are sinks.
...
14) **Use MCP servers** for all external integrations (Airtable, Webflow, n8n, etc.).
